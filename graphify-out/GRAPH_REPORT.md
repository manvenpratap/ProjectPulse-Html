...
## Corpus Check
- 4 files · ~538,812 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1270 nodes · 2869 edges · 54 communities (45 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `38d05592`
...
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 2 → community 16_
...
Cohesion: 0.05
Nodes (69): addCustomFieldV(), addDep(), addLeaveRow(), cancelTplConfirmV(), clearPvFilt(), closeCmdPalette(), closeCtx(), closeDefectFlyout() (+61 more)
...
Cohesion: 0.05
Nodes (63): addLog(), applyDashLayout(), applyReportLayout(), applyTemplate(), autoPopulateReport(), buildBoardPackContent(), closeFlyout(), closeMemberFlyout() (+55 more)
...
Cohesion: 0.09
Nodes (25): addScaffoldRow(), cancelEditFeature(), closeAllFlyouts(), closeFeatFlyout(), closeTplFlyout(), duplicateScaffoldRow(), finalizeTplUpdateV(), generateFromScaffold() (+17 more)
...
- **Why does `$id()` connect `Architecture & Audit & State` to `Readme & State & Block`, `Changelog & 2026 & 05`, `Scheduler & The & Heuristic`, `Community 40`, `Overview & Md & Executive`, `Readme & Md & Project`, `Community 45`, `Defects & Defect & Bug`, `Activity & Md & Audit`, `Community 48`, `Capacity & Workload & Role`, `Defect Tracker & Bug Lifecycle`, `Reports & Board & Export`, `Widgets & Capture & Screenshot`, `Status & Dashboard & Live`, `Community 28`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `$id()` connect `Manual & State & Md` to `Configuration & Reference & Status`, `Readme & Typescript & Entity`, `Risks & Raid & Md`, `Delivery & Md & Hierarchical`, `Insights & Burn & Md`, `Team & Capacity & Role`, `Reports & Board & Md`, `Project & Status & Md`, `Audit Log & Activity & Session`, `Community 26`, `Community 27`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 35`, `Community 39`, `Community 42`, `Community 44`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `notify()` connect `Changelog & 2026 & 05` to `Readme & State & Block`, `Architecture & Audit & State`, `Overview & Md & Executive`, `Readme & Md & Project`, `Defects & Defect & Bug`, `Activity & Md & Audit`, `Capacity & Workload & Role`, `Reports & Board & Export`, `Widgets & Capture & Screenshot`, `Status & Dashboard & Live`, `Community 28`?**
