...
## Corpus Check
- 4 files · ~541,309 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1270 nodes · 2869 edges · 60 communities (52 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d0e1f13b`
...
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 9 → community 15_
- `updateBulkBar()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 9 → community 47_
- `applyBulkEdit()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 9 → community 12_
- `submitComment()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 9 → community 3_
...
Cohesion: 0.06
Nodes (49): addLog(), addNewGUIScreen(), addRelease(), applyWorkflowTemplate(), clearProjectState(), closeMemberFlyout(), commitSchedulerSchedule(), deleteMember() (+41 more)
...
Cohesion: 0.08
Nodes (33): addDDValueV(), autoPopulateReport(), captureAreaAsCanvas(), captureFullGanttChart(), closeTplFlyout(), copyAllShares(), copyChart(), copyWidgetAsImage() (+25 more)

### Community 9 - "Risks & Raid & Md"
Cohesion: 0.09
Nodes (29): addDep(), addLeaveRow(), clearPvFilt(), closeCmdPalette(), closeEwsModal(), drawProgressRing(), $id(), openBulkDD() (+21 more)
...
Cohesion: 0.08
Nodes (28): addEmptyState(), commitWhatIfScenario(), esc(), fmtDate(), getModuleMilestones(), _matrixCellHover(), _matrixStateChange(), openAddTask() (+20 more)
...
Cohesion: 0.09
Nodes (24): addRelease(), addScaffoldRow(), createBaselineSnapshot(), deleteBaselineSnapshot(), deleteRelease(), duplicateScaffoldRow(), editReport(), generateFromScaffold() (+16 more)
...
- **Why does `$id()` connect `Risks & Raid & Md` to `Readme & State & Block`, `Manual & State & Md`, `Readme & Typescript & Entity`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Delivery & Md & Hierarchical`, `Insights & Burn & Md`, `Reports & Board & Md`, `Defect Tracker & Bug Lifecycle`, `Audit Log & Activity & Session`, `Community 26`, `Community 28`, `Community 30`, `Community 32`, `Community 38`, `Community 39`, `Community 40`, `Community 45`, `Community 46`, `Community 47`, `Community 52`, `Community 53`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `$id()` connect `Architecture & Audit & State` to `Configuration & Reference & Status`, `Schedule & Manual & Check`, `Readme & Md & Project`, `Team & Capacity & Role`, `Defects & Defect & Bug`, `Activity & Md & Audit`, `Project & Status & Md`, `Delivery Matrix & Hierarchy & Edit`, `Reports & Board & Export`, `Widgets & Capture & Screenshot`, `Status & Dashboard & Live`, `Community 27`, `Community 29`, `Community 31`, `Community 33`, `Community 36`, `Community 44`, `Community 50`, `Community 51`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `notify()` connect `Overview & Md & Executive` to `Community 32`, `Readme & State & Block`, `Manual & State & Md`, `Scheduler & The & Heuristic`, `Community 40`, `Delivery & Md & Hierarchical`, `Insights & Burn & Md`, `Reports & Board & Md`, `Defect Tracker & Bug Lifecycle`, `Audit Log & Activity & Session`, `Community 26`, `Community 30`?**
