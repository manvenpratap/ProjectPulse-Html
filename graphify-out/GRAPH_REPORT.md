...
## Corpus Check
- 5 files · ~497,366 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1270 nodes · 2869 edges · 69 communities (60 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `eceb924f`
...
- `renderViewToggle()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 10 → community 25_
...
- `updateBulkBar()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 10 → community 52_
...
- `openCmdPalette()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 10 → community 51_
...
Cohesion: 0.05
Nodes (63): addDDValueV(), addRelease(), applyDashLayout(), applyReportLayout(), applyTemplate(), buildBoardPackContent(), closeModal(), createNewGlobalSet() (+55 more)
...
Cohesion: 0.07
Nodes (42): autoPopulateReport(), captureAreaAsCanvas(), captureFullGanttChart(), closeRaidFlyout(), closeTplFlyout(), copyAllShares(), copyChart(), copyWidgetAsImage() (+34 more)
...
Cohesion: 0.07
Nodes (32): addLog(), addNewGUIScreen(), applyWorkflowTemplate(), closeFlyout(), closeMemberFlyout(), commitSchedulerSchedule(), confirmDeleteTask(), deleteMember() (+24 more)

### Community 8 - "Overview & Md & Executive"
Cohesion: 0.1
Nodes (27): addEmptyState(), closeCtx(), esc(), formatDateStringFriendly(), getModuleMilestones(), _matrixCellHover(), _matrixStateChange(), openAddTask() (+19 more)
...
Cohesion: 0.1
Nodes (21): addScaffoldRow(), createBaselineSnapshot(), deleteBaselineSnapshot(), duplicateScaffoldRow(), generateFromScaffold(), listBackups(), loadScaffoldTemplate(), removeScaffoldRow() (+13 more)
...
- **Why does `$id()` connect `Readme & Md & Project` to `Readme & State & Block`, `Architecture & Audit & State`, `Changelog & 2026 & 05`, `Readme & Typescript & Entity`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Risks & Raid & Md`, `Activity & Md & Audit`, `Reports & Board & Export`, `Status & Dashboard & Live`, `Community 29`, `Community 31`, `Community 33`, `Community 34`, `Community 35`, `Community 38`, `Community 41`, `Community 42`, `Community 49`, `Community 51`, `Community 52`, `Community 62`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `$id()` connect `Insights & Burn & Md` to `Configuration & Reference & Status`, `Schedule & Manual & Check`, `Delivery & Md & Hierarchical`, `Team & Capacity & Role`, `Reports & Board & Md`, `Project & Status & Md`, `User Manual & Architecture & Sync`, `Delivery Matrix & Hierarchy & Edit`, `Defect Tracker & Bug Lifecycle`, `Audit Log & Activity & Session`, `Widgets & Capture & Screenshot`, `Community 26`, `Community 27`, `Community 28`, `Community 30`, `Community 32`, `Community 37`, `Community 39`, `Community 40`, `Community 43`, `Community 44`, `Community 47`, `Community 50`, `Community 54`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 68`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `save()` connect `Architecture & Audit & State` to `Readme & State & Block`, `Community 33`, `Community 35`, `Changelog & 2026 & 05`, `Community 34`, `Readme & Typescript & Entity`, `Scheduler & The & Heuristic`, `Risks & Raid & Md`, `Community 46`, `Activity & Md & Audit`, `Status & Dashboard & Live`, `Community 31`?**
