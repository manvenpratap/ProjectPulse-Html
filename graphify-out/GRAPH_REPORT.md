...
## Corpus Check
- 4 files · ~273,931 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1270 nodes · 2869 edges · 63 communities (54 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bce181ec`
...
- `renderViewToggle()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 10 → community 17_
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 10 → community 5_
- `syncFsDirectory()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 10 → community 39_
- `updateBulkBar()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 10 → community 50_
- `applyBulkEdit()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 10 → community 11_
...
Cohesion: 0.05
Nodes (60): addCustomFieldV(), addDep(), addLeaveRow(), cancelTplConfirmV(), clearPvFilt(), closeCmdPalette(), closeDefectFlyout(), closeDefectLinkDropdown() (+52 more)

### Community 3 - "Manual & State & Md"
Cohesion: 0.05
Nodes (53): addDDValueV(), addNewGUIScreen(), addRelease(), applyWorkflowTemplate(), clearProjectState(), closeMemberFlyout(), commitSchedulerSchedule(), createNewGlobalSet() (+45 more)
...
Cohesion: 0.06
Nodes (42): addLog(), applyPvFilt(), applyTemplate(), autoPopulateReport(), cap(), closeModal(), closeRaidFlyout(), closeTplFlyout() (+34 more)
...
Cohesion: 0.11
Nodes (31): applyDashLayout(), applyReportLayout(), buildBoardPackContent(), cancelEditCw(), cycleCwSize(), cycleStandardSize(), editCustomWidgetCtx(), editCw() (+23 more)

### Community 9 - "Risks & Raid & Md"
Cohesion: 0.08
Nodes (28): addRelease(), addScaffoldRow(), deleteFeature(), deleteRelease(), duplicateScaffoldRow(), generateFromScaffold(), initFeatGanttResizer(), initFeatScreenSearch() (+20 more)
...
Cohesion: 0.11
Nodes (19): addScaffoldRow(), createBaselineSnapshot(), deleteBaselineSnapshot(), duplicateScaffoldRow(), generateFromScaffold(), loadScaffoldTemplate(), removeScaffoldRow(), renderAdminView() (+11 more)

### Community 20 - "Capacity & Workload & Role"
Cohesion: 0.13
Nodes (19): addLog(), applyTemplate(), closeModal(), commitSchedulerSchedule(), deleteMember(), drawAreaChart(), drawVBar(), reconstructProjectFromBuffer() (+11 more)

### Community 21 - "Defect Tracker & Bug Lifecycle"
Cohesion: 0.12
Nodes (18): commitWhatIfScenario(), deleteReport(), filterTasksByAssignee(), filterTasksByRole(), filterToWeek(), fmtDate(), generateFullBoardPackHtml(), renderSkeleton() (+10 more)

### Community 22 - "Reports & Board & Export"
Cohesion: 0.11
Nodes (18): cancelEditFeature(), closeFeatFlyout(), deleteFeature(), featRemoveScreen(), initFeatGanttResizer(), initFeatScreenSearch(), openFeatFlyout(), renderFeatScreenChips() (+10 more)

### Community 23 - "Audit Log & Activity & Session"
Cohesion: 0.18
Nodes (18): applyReportLayout(), buildBoardPackContent(), cycleCwSize(), cycleStandardSize(), getBoardPackHtml(), getModuleMilestones(), renderDash(), renderReports() (+10 more)
...
Cohesion: 0.14
Nodes (14): cancelEditFeature(), closeAllFlyouts(), closeFeatFlyout(), createBaselineSnapshot(), deleteBaselineSnapshot(), editReport(), importScaffoldBulk(), openNewReport() (+6 more)
...
Cohesion: 0.16
Nodes (14): autoPopulateReport(), closeMemberFlyout(), closeRaidFlyout(), closeTplFlyout(), deleteRaidItem(), deleteRaidItemById(), finalizeTplUpdateV(), notify() (+6 more)
...
Cohesion: 0.25
Nodes (8): addCustomFieldV(), closeAllFlyouts(), importScaffoldBulk(), openRaidModal(), renderCFListV(), renderFieldsView(), todayStr(), toggleRaidProb()
...
Cohesion: 0.36
Nodes (8): applyDashLayout(), captureAreaAsCanvas(), captureFullFeatureGantt(), captureFullGanttChart(), copyAllShares(), copyChart(), copyWidgetAsImage(), error()
...
- **Why does `$id()` connect `Readme & Md & Project` to `Readme & State & Block`, `Manual & State & Md`, `Schedule & Manual & Check`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Delivery & Md & Hierarchical`, `Project & Status & Md`, `Delivery Matrix & Hierarchy & Edit`, `Defect Tracker & Bug Lifecycle`, `Reports & Board & Export`, `Widgets & Capture & Screenshot`, `Community 28`, `Community 34`, `Community 38`, `Community 39`, `Community 40`, `Community 41`, `Community 47`, `Community 48`, `Community 50`, `Community 56`, `Community 57`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `$id()` connect `Architecture & Audit & State` to `Configuration & Reference & Status`, `Readme & Typescript & Entity`, `Risks & Raid & Md`, `Insights & Burn & Md`, `Team & Capacity & Role`, `Defects & Defect & Bug`, `Activity & Md & Audit`, `Capacity & Workload & Role`, `Audit Log & Activity & Session`, `Status & Dashboard & Live`, `Community 26`, `Community 27`, `Community 29`, `Community 30`, `Community 31`, `Community 33`, `Community 36`, `Community 46`, `Community 51`, `Community 53`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `notify()` connect `Schedule & Manual & Check` to `Readme & State & Block`, `Community 34`, `Manual & State & Md`, `Community 39`, `Overview & Md & Executive`, `Community 41`, `Delivery & Md & Hierarchical`, `Delivery Matrix & Hierarchy & Edit`, `Defect Tracker & Bug Lifecycle`, `Reports & Board & Export`, `Widgets & Capture & Screenshot`, `Community 28`?**
