...
## Corpus Check
- 4 files · ~396,684 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2394 nodes · 4951 edges · 63 communities (54 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9eb52fd9`
...
- `copyCxoEmailToClipboard()` --calls--> `warn()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 34 → community 22_
- `syncFsDirectory()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 39 → community 34_
- `restoreFromFileBackup()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 39 → community 14_
- `updateCxoEmailPreview()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 39 → community 22_
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 5 → community 23_
...
Cohesion: 0.01
Nodes (99): activeModal, addGrid(), addST(), allDone, anyStarted, autoFitAllCols(), blocked, bulkDeleteTasks() (+91 more)

### Community 2 - "Architecture & Audit & State"
Cohesion: 0.01
Nodes (81): activeModal, allDone, anyStarted, autoFitAllCols(), blocked, bulkDeleteTasks(), bulkSelectedTasks, c (+73 more)

### Community 3 - "Manual & State & Md"
Cohesion: 0.04
Nodes (93): addDep(), addLeaveRow(), cancelTplConfirmV(), cap(), clearPvFilt(), closeCmdPalette(), closeCtx(), closeDefectLinkDropdown() (+85 more)
...
Cohesion: 0.05
Nodes (73): addCustomFieldV(), addDep(), addLeaveRow(), autoInferCategory(), autoInferRelease(), cancelEditFeature(), cancelTplConfirmV(), clearPvFilt() (+65 more)
...
Cohesion: 0.06
Nodes (49): addDDValueV(), addRelease(), clearProjectState(), closeRaidFlyout(), computeAlerts(), createNewGlobalSet(), deleteGlobalSet(), deleteRaidItem() (+41 more)

### Community 8 - "Overview & Md & Executive"
Cohesion: 0.07
Nodes (49): applyDashLayout(), applyReportLayout(), applyTemplate(), autoPopulateReport(), buildBoardPackContent(), captureAreaAsCanvas(), captureFullGanttChart(), closeModal() (+41 more)
...
Cohesion: 0.07
Nodes (44): clearMatrixFilter(), closeRaidFlyout(), deleteFeature(), deleteRaidItem(), deleteRaidItemById(), filterDashboardMetric(), filterDefectsBy(), filterRaid() (+36 more)

### Community 11 - "Delivery & Md & Hierarchical"
Cohesion: 0.07
Nodes (44): autoResolveAllSchedulerConflicts(), autoSequenceAssignee(), changeSchedulerWeek(), clearMatrixFilter(), closeRaidFlyout(), deleteRaidItem(), deleteRaidItemById(), filterDashboardMetric() (+36 more)

### Community 12 - "Insights & Burn & Md"
Cohesion: 0.08
Nodes (41): addDDValueV(), addRelease(), animateCounter(), applyBulkEdit(), applyReportLayout(), buildBoardPackContent(), commitWhatIfScenario(), createNewGlobalSet() (+33 more)

### Community 13 - "Team & Capacity & Role"
Cohesion: 0.06
Nodes (35): addCustomFieldV(), addScaffoldRow(), cancelEditFeature(), closeAllFlyouts(), closeFeatFlyout(), closeTplFlyout(), createBaselineSnapshot(), deleteBaselineSnapshot() (+27 more)

### Community 14 - "Defects & Defect & Bug"
Cohesion: 0.09
Nodes (33): addLog(), applyDashLayout(), applyTemplate(), autoPopulateReport(), closeDefectFlyout(), closeMemberFlyout(), closeModal(), closeTplFlyout() (+25 more)
...
Cohesion: 0.1
Nodes (32): addEmptyState(), applyBulkEdit(), autoFitCol(), doGridSort(), doSort(), finalizeColOrder(), getGridFiltered(), getGridPK() (+24 more)
...
Cohesion: 0.07
Nodes (31): addCustomFieldV(), addScaffoldRow(), cancelEditFeature(), closeAllFlyouts(), closeFeatFlyout(), createBaselineSnapshot(), deleteBaselineSnapshot(), duplicateScaffoldRow() (+23 more)
...
Cohesion: 0.09
Nodes (27): addNewGUIScreen(), aggregateCustomData(), applyWorkflowTemplate(), entries, esc(), fmtDate(), getFilteredLogs(), markAllGUIStepsDone() (+19 more)
...
Cohesion: 0.19
Nodes (21): autoFitCol(), doGridSort(), doSort(), finalizeColOrder(), getGridFiltered(), getGridPK(), getGridSorted(), moveCol() (+13 more)

### Community 27 - "Community 27"
Cohesion: 0.13
Nodes (21): clearProjectState(), computeAlerts(), dismissAlert(), dismissAllAlerts(), enterApp(), loadCustomLayouts(), loadSample(), moveViewOrder() (+13 more)
...
Cohesion: 0.15
Nodes (19): captureAreaAsCanvas(), captureFullFeatureGantt(), captureFullGanttChart(), copyAllShares(), copyChart(), copyWidgetAsImage(), createFileBackup(), downloadGanttAsHtml() (+11 more)

### Community 30 - "Community 30"
Cohesion: 0.14
Nodes (18): downloadGanttAsHtml(), getFiltered(), getModuleMilestones(), getSorted(), getTasksForDisplayLevel(), initFeatGanttResizer(), rect, renderFeatureGantt() (+10 more)
...
Cohesion: 0.16
Nodes (14): createFileBackup(), listBackups(), loadCustomLayouts(), openSettings(), printContainer(), renderAdminContent(), renderBackupList(), renderBackupListInline() (+6 more)
...
Cohesion: 0.4
Nodes (6): formatDateStringFriendly(), positionTooltip(), renderConflictCard(), showCellTooltip(), showSchedulerTooltip(), showTaskTooltip()
...
- **Why does `$id()` connect `Schedule & Manual & Check` to `Configuration & Reference & Status`, `Community 34`, `Community 35`, `Community 38`, `Readme & Md & Project`, `Community 42`, `Insights & Burn & Md`, `Defects & Defect & Bug`, `Delivery Matrix & Hierarchy & Edit`, `Capacity & Workload & Role`, `Community 53`, `Community 52`, `Audit Log & Activity & Session`, `Reports & Board & Export`, `Community 26`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `$id()` connect `Readme & Typescript & Entity` to `Architecture & Audit & State`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Community 41`, `Risks & Raid & Md`, `Community 44`, `Team & Capacity & Role`, `Reports & Board & Md`, `Project & Status & Md`, `Defect Tracker & Bug Lifecycle`, `Widgets & Capture & Screenshot`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `$id()` connect `Manual & State & Md` to `Community 32`, `Readme & State & Block`, `Community 33`, `Changelog & 2026 & 05`, `Delivery & Md & Hierarchical`, `Activity & Md & Audit`, `User Manual & Architecture & Sync`, `Community 27`, `Community 29`?**
