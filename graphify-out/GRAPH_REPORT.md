# Graph Report - ProjectPulse  (2026-08-16)

## Corpus Check
- 4 files · ~318,660 words
...
- `copyCxoEmailToClipboard()` --calls--> `warn()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 24 → community 23_
- `syncFsDirectory()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 38 → community 24_
- `restoreFromFileBackup()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 38 → community 13_
...
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 6 → community 8_
...
Cohesion: 0.03
Nodes (95): addCustomFieldV(), addDep(), addLeaveRow(), addScaffoldRow(), cancelEditFeature(), cancelTplConfirmV(), clearPvFilt(), closeAllFlyouts() (+87 more)

### Community 4 - "Changelog & 2026 & 05"
Cohesion: 0.06
Nodes (73): addDDValueV(), addLog(), addRelease(), applyDashLayout(), applyReportLayout(), applyTemplate(), autoPopulateReport(), buildBoardPackContent() (+65 more)
...
Cohesion: 0.06
Nodes (51): animateCounter(), applyPvFilt(), applyReportLayout(), buildBoardPackContent(), cancelEditCw(), cap(), cycleCwSize(), cycleStandardSize() (+43 more)
...
Cohesion: 0.07
Nodes (43): clearMatrixFilter(), closeRaidFlyout(), deleteFeature(), deleteRaidItem(), deleteRaidItemById(), filterDashboardMetric(), filterDefectsBy(), filterRaid() (+35 more)

### Community 12 - "Insights & Burn & Md"
Cohesion: 0.07
Nodes (40): addCustomFieldV(), addDDValueV(), addScaffoldRow(), autoPopulateReport(), cancelEditFeature(), closeAllFlyouts(), closeFeatFlyout(), closeTplFlyout() (+32 more)

### Community 13 - "Team & Capacity & Role"
Cohesion: 0.08
Nodes (38): addLog(), applyDashLayout(), applyTemplate(), autoPopulateReport(), cancelEditFeature(), closeAllFlyouts(), closeDefectFlyout(), closeFeatFlyout() (+30 more)
...
Cohesion: 0.07
Nodes (33): addEmptyState(), addGrid(), addST(), downloadGanttAsHtml(), esc(), formatDateStringFriendly(), _matrixCellHover(), _matrixStateChange() (+25 more)
...
Cohesion: 0.09
Nodes (30): addDDValueV(), addRelease(), clearProjectState(), createNewGlobalSet(), deleteGlobalSet(), deleteRelease(), enterApp(), keys (+22 more)

### Community 18 - "User Manual & Architecture & Sync"
Cohesion: 0.09
Nodes (29): applyDashLayout(), captureAreaAsCanvas(), captureFullFeatureGantt(), captureFullGanttChart(), copyAllShares(), copyChart(), copyWidgetAsImage(), createFileBackup() (+21 more)
...
Cohesion: 0.1
Nodes (25): closeRaidFlyout(), computeAlerts(), deleteRaidItem(), deleteRaidItemById(), dismissAlert(), dismissAllAlerts(), enterApp(), initApp() (+17 more)
...
Cohesion: 0.09
Nodes (24): createBaselineSnapshot(), createFileBackup(), deleteBaselineSnapshot(), formatRaidDateSince(), getRaidAgeDays(), getRaidDateSince(), listBackups(), loadCustomLayouts() (+16 more)
...
Cohesion: 0.18
Nodes (21): applyBulkEdit(), autoFitCol(), doGridSort(), doSort(), finalizeColOrder(), getGridPK(), getGridSorted(), moveCol() (+13 more)
...
Cohesion: 0.46
Nodes (8): computeAlerts(), dismissAlert(), dismissAllAlerts(), pruneAlertHistory(), reactivateAlert(), renderAlertsPanel(), toggleAlerts(), updateAlertsBadge()
...
- **Why does `$id()` connect `Readme & Typescript & Entity` to `Configuration & Reference & Status`, `Community 34`, `Overview & Md & Executive`, `Community 40`, `Delivery & Md & Hierarchical`, `Community 43`, `Team & Capacity & Role`, `Project & Status & Md`, `Community 50`, `Delivery Matrix & Hierarchy & Edit`, `Community 51`, `Audit Log & Activity & Session`, `Widgets & Capture & Screenshot`, `Status & Dashboard & Live`, `Community 28`, `Community 31`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `$id()` connect `Manual & State & Md` to `Community 32`, `Readme & State & Block`, `Community 33`, `Changelog & 2026 & 05`, `Risks & Raid & Md`, `Defects & Defect & Bug`, `Activity & Md & Audit`, `Capacity & Workload & Role`, `Reports & Board & Export`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `$id()` connect `Scheduler & The & Heuristic` to `Architecture & Audit & State`, `Community 35`, `Schedule & Manual & Check`, `Readme & Md & Project`, `Community 42`, `Insights & Burn & Md`, `Reports & Board & Md`, `User Manual & Architecture & Sync`, `Defect Tracker & Bug Lifecycle`, `Community 26`, `Community 29`?**
