...
- `copyCxoEmailToClipboard()` --calls--> `warn()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 18 → community 24_
- `syncFsDirectory()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 37 → community 18_
- `restoreFromFileBackup()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 37 → community 7_
- `updateCxoEmailPreview()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 37 → community 24_
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 6 → community 22_
...
Cohesion: 0.03
Nodes (106): addCustomFieldV(), addDep(), addLeaveRow(), addScaffoldRow(), cancelEditFeature(), cancelTplConfirmV(), clearPvFilt(), closeAllFlyouts() (+98 more)
...
Cohesion: 0.06
Nodes (60): addDDValueV(), addLog(), addRelease(), applyDashLayout(), applyTemplate(), autoPopulateReport(), clearProjectState(), closeDefectFlyout() (+52 more)

### Community 8 - "Overview & Md & Executive"
Cohesion: 0.06
Nodes (55): cancelEditFeature(), clearMatrixFilter(), closeAllFlyouts(), closeFeatFlyout(), closeRaidFlyout(), deleteFeature(), deleteRaidItem(), deleteRaidItemById() (+47 more)

### Community 9 - "Risks & Raid & Md"
Cohesion: 0.07
Nodes (49): addDDValueV(), addRelease(), applyReportLayout(), buildBoardPackContent(), createNewGlobalSet(), cycleCwSize(), cycleStandardSize(), deleteGlobalSet() (+41 more)

### Community 10 - "Readme & Md & Project"
Cohesion: 0.07
Nodes (48): addLog(), applyDashLayout(), applyTemplate(), autoPopulateReport(), captureAreaAsCanvas(), captureFullFeatureGantt(), captureFullGanttChart(), closeDefectFlyout() (+40 more)
...
Cohesion: 0.17
Nodes (13): createFileBackup(), downloadGanttAsHtml(), exportFeatureMatrixExcel(), exportLogCSV(), exportProjectExcel(), generateProjectWorkbook(), getExcelFileBlob(), printContainer() (+5 more)
...
- **Why does `$id()` connect `Readme & Typescript & Entity` to `Configuration & Reference & Status`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Community 39`, `Community 42`, `Community 41`, `Team & Capacity & Role`, `Project & Status & Md`, `User Manual & Architecture & Sync`, `Community 50`, `Community 49`, `Reports & Board & Export`, `Audit Log & Activity & Session`, `Widgets & Capture & Screenshot`, `Community 27`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `$id()` connect `Changelog & 2026 & 05` to `Community 33`, `Architecture & Audit & State`, `Community 34`, `Schedule & Manual & Check`, `Delivery & Md & Hierarchical`, `Defects & Defect & Bug`, `Reports & Board & Md`, `Delivery Matrix & Hierarchy & Edit`, `Community 28`, `Community 30`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `$id()` connect `Manual & State & Md` to `Readme & State & Block`, `Community 35`, `Community 38`, `Risks & Raid & Md`, `Readme & Md & Project`, `Insights & Burn & Md`, `Activity & Md & Audit`, `Capacity & Workload & Role`, `Defect Tracker & Bug Lifecycle`, `Community 29`?**
