...
## Corpus Check
- 5 files · ~498,837 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1270 nodes · 2869 edges · 61 communities (54 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `de77f261`
...
- `renderViewToggle()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 2 → community 23_
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 2 → community 13_
...
- `updateBulkBar()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 2 → community 48_
...
Cohesion: 0.05
Nodes (67): addCustomFieldV(), addDep(), addLeaveRow(), cancelTplConfirmV(), clearPvFilt(), closeCmdPalette(), closeCtx(), closeDefectFlyout() (+59 more)

### Community 3 - "Manual & State & Md"
Cohesion: 0.05
Nodes (62): addCustomFieldV(), addDep(), addLeaveRow(), cancelTplConfirmV(), clearPvFilt(), closeCmdPalette(), closeDefectFlyout(), closeDefectLinkDropdown() (+54 more)
...
Cohesion: 0.08
Nodes (38): autoResolveAllSchedulerConflicts(), autoSequenceAssignee(), changeSchedulerWeek(), clearMatrixFilter(), filterRaid(), findScheduleConflicts(), generateIntelligentSuggestions(), getSorted() (+30 more)

### Community 7 - "Scheduler & The & Heuristic"
Cohesion: 0.06
Nodes (36): addScaffoldRow(), cancelEditFeature(), closeAllFlyouts(), closeFeatFlyout(), closeTplFlyout(), createBaselineSnapshot(), deleteBaselineSnapshot(), duplicateScaffoldRow() (+28 more)

### Community 8 - "Overview & Md & Executive"
Cohesion: 0.07
Nodes (32): addEmptyState(), createFileBackup(), esc(), formatDateStringFriendly(), generateProjectWorkbook(), getExcelFileBlob(), getModuleMilestones(), listBackups() (+24 more)
...
Cohesion: 0.11
Nodes (22): createFileBackup(), downloadGanttAsHtml(), exportFeatureMatrixExcel(), exportLogCSV(), exportProjectExcel(), generateProjectWorkbook(), getExcelFileBlob(), listBackups() (+14 more)
...
Cohesion: 0.14
Nodes (16): commitSchedulerSchedule(), deleteMember(), drawAreaChart(), drawLineChart(), drawVBar(), drawVelocityLine(), filterDashboardMetric(), filterTasksByAssignee() (+8 more)
...
Cohesion: 0.19
Nodes (13): addRelease(), closeRaidFlyout(), deleteRaidItem(), deleteRaidItemById(), deleteRelease(), recalcGUIScreenByRefs(), renderReleases(), save() (+5 more)
...
Cohesion: 0.23
Nodes (12): applyDashLayout(), applyTemplate(), autoPopulateReport(), closeModal(), notify(), openAddMember(), reconstructProjectFromBuffer(), resetDashLayout() (+4 more)
...
Cohesion: 0.67
Nodes (3): closeMemberFlyout(), saveMember(), showValidationErrors()
...
## Knowledge Gaps
- **179 isolated node(s):** `PulseUtils`, `PulseConstants`, `PulseForecastEngine`, `PulseDashboard`, `PulseUI` (+174 more)
...
- **Why does `$id()` connect `Architecture & Audit & State` to `Readme & State & Block`, `Readme & Typescript & Entity`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Risks & Raid & Md`, `Team & Capacity & Role`, `Defect Tracker & Bug Lifecycle`, `Reports & Board & Export`, `Audit Log & Activity & Session`, `Widgets & Capture & Screenshot`, `Community 27`, `Community 29`, `Community 31`, `Community 32`, `Community 36`, `Community 37`, `Community 40`, `Community 41`, `Community 42`, `Community 47`, `Community 48`, `Community 50`, `Community 54`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `$id()` connect `Manual & State & Md` to `Configuration & Reference & Status`, `Schedule & Manual & Check`, `Readme & Md & Project`, `Delivery & Md & Hierarchical`, `Insights & Burn & Md`, `Reports & Board & Md`, `Activity & Md & Audit`, `Project & Status & Md`, `Delivery Matrix & Hierarchy & Edit`, `Capacity & Workload & Role`, `Status & Dashboard & Live`, `Community 26`, `Community 28`, `Community 30`, `Community 33`, `Community 34`, `Community 39`, `Community 45`, `Community 51`, `Community 52`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `save()` connect `Community 27` to `Readme & State & Block`, `Architecture & Audit & State`, `Community 35`, `Community 36`, `Community 37`, `Readme & Typescript & Entity`, `Scheduler & The & Heuristic`, `Community 40`, `Community 41`, `Risks & Raid & Md`, `Community 42`, `Community 44`, `Community 50`, `Defect Tracker & Bug Lifecycle`, `Reports & Board & Export`, `Audit Log & Activity & Session`, `Community 29`, `Community 31`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **What connects `PulseUtils`, `PulseConstants`, `PulseForecastEngine` to the rest of the system?**
