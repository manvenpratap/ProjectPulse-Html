# Graph Report - ProjectPulse  (2026-07-24)

## Corpus Check
- 4 files · ~271,271 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1270 nodes · 2869 edges · 63 communities (53 shown, 10 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `19aeafec`
...
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 2 → community 15_
...
- `updateBulkBar()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 2 → community 45_
- `applyBulkEdit()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 2 → community 11_
...
Cohesion: 0.05
Nodes (66): addDep(), addLeaveRow(), cancelTplConfirmV(), clearPvFilt(), closeCmdPalette(), closeCtx(), closeDefectFlyout(), closeDefectLinkDropdown() (+58 more)

### Community 3 - "Manual & State & Md"
Cohesion: 0.05
Nodes (62): addRelease(), applyDashLayout(), applyReportLayout(), applyTemplate(), buildBoardPackContent(), closeMemberFlyout(), closeModal(), commitSchedulerSchedule() (+54 more)

### Community 4 - "Changelog & 2026 & 05"
Cohesion: 0.05
Nodes (53): addCustomFieldV(), addDDValueV(), addScaffoldRow(), autoPopulateReport(), cancelEditFeature(), captureAreaAsCanvas(), captureFullGanttChart(), closeAllFlyouts() (+45 more)
...
Cohesion: 0.07
Nodes (28): addRelease(), addScaffoldRow(), createBaselineSnapshot(), deleteBaselineSnapshot(), deleteRelease(), duplicateScaffoldRow(), editReport(), generateFromScaffold() (+20 more)

### Community 10 - "Readme & Md & Project"
Cohesion: 0.08
Nodes (27): addEmptyState(), createFileBackup(), esc(), generateProjectWorkbook(), getExcelFileBlob(), listBackups(), _matrixCellHover(), _matrixStateChange() (+19 more)
...
Cohesion: 0.16
Nodes (19): applyDashLayout(), applyReportLayout(), buildBoardPackContent(), cycleCwSize(), cycleStandardSize(), getBoardPackHtml(), getModuleMilestones(), renderDash() (+11 more)
...
- **Why does `$id()` connect `Architecture & Audit & State` to `Readme & State & Block`, `Community 35`, `Changelog & 2026 & 05`, `Manual & State & Md`, `Scheduler & The & Heuristic`, `Readme & Md & Project`, `Delivery & Md & Hierarchical`, `Community 43`, `Community 45`, `Reports & Board & Md`, `Community 47`, `Delivery Matrix & Hierarchy & Edit`, `Reports & Board & Export`, `Community 54`, `Widgets & Capture & Screenshot`, `Community 57`, `Community 28`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `$id()` connect `Team & Capacity & Role` to `Configuration & Reference & Status`, `Readme & Typescript & Entity`, `Overview & Md & Executive`, `Risks & Raid & Md`, `Insights & Burn & Md`, `Defects & Defect & Bug`, `Project & Status & Md`, `User Manual & Architecture & Sync`, `Defect Tracker & Bug Lifecycle`, `Audit Log & Activity & Session`, `Status & Dashboard & Live`, `Community 26`, `Community 27`, `Community 29`, `Community 30`, `Community 31`, `Community 34`, `Community 36`, `Community 39`, `Community 42`, `Community 44`, `Community 48`, `Community 50`, `Community 51`, `Community 52`, `Community 62`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `notify()` connect `Changelog & 2026 & 05` to `Readme & State & Block`, `Architecture & Audit & State`, `Manual & State & Md`, `Community 35`, `Readme & Md & Project`, `Delivery & Md & Hierarchical`, `Reports & Board & Md`, `Delivery Matrix & Hierarchy & Edit`, `Reports & Board & Export`, `Community 28`?**
