...
## Corpus Check
- 4 files · ~298,647 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1270 nodes · 2869 edges · 65 communities (54 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1ffde8e1`
...
- `renderViewToggle()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 3 → community 16_
...
- `updateBulkBar()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 3 → community 46_
- `applyBulkEdit()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 3 → community 10_
...
Cohesion: 0.06
Nodes (70): addCustomFieldV(), addDDValueV(), addLog(), applyDashLayout(), applyReportLayout(), applyTemplate(), buildBoardPackContent(), clearProjectState() (+62 more)

### Community 3 - "Manual & State & Md"
Cohesion: 0.05
Nodes (68): addDep(), addLeaveRow(), autoPopulateReport(), cancelTplConfirmV(), clearPvFilt(), closeCmdPalette(), closeDefectFlyout(), closeDefectLinkDropdown() (+60 more)
...
Cohesion: 0.07
Nodes (30): addRelease(), addScaffoldRow(), cancelEditFeature(), closeAllFlyouts(), closeFeatFlyout(), closeTplFlyout(), deleteRelease(), duplicateScaffoldRow() (+22 more)
...
Cohesion: 0.11
Nodes (29): addLog(), applyDashLayout(), applyTemplate(), autoPopulateReport(), closeMemberFlyout(), closeModal(), closeTplFlyout(), commitSchedulerSchedule() (+21 more)
...
Cohesion: 0.1
Nodes (25): addEmptyState(), closeCtx(), esc(), generateFullBoardPackHtml(), getModuleMilestones(), _matrixCellHover(), _matrixStateChange(), openAddTask() (+17 more)
...
Cohesion: 0.09
Nodes (22): commitWhatIfScenario(), enterApp(), filterTasksByAssignee(), filterTasksByRole(), filterToWeek(), initApp(), initDesignSpells(), initGanttResizer() (+14 more)
...
Cohesion: 0.15
Nodes (19): closeRaidFlyout(), computeAlerts(), createBaselineSnapshot(), deleteBaselineSnapshot(), deleteRaidItem(), dismissAlert(), dismissAllAlerts(), nowISO() (+11 more)
...
Cohesion: 0.2
Nodes (12): addNewGUIScreen(), applyWorkflowTemplate(), fmtDate(), markAllGUIStepsDone(), openScreenFlyout(), renderGUIScreens(), renderWhatIfSandbox(), resetWhatIfSandbox() (+4 more)
...
- **Why does `$id()` connect `Manual & State & Md` to `Readme & State & Block`, `Architecture & Audit & State`, `Community 26`, `Readme & Typescript & Entity`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Readme & Md & Project`, `Team & Capacity & Role`, `Community 46`, `Community 47`, `Activity & Md & Audit`, `Defect Tracker & Bug Lifecycle`, `Community 54`, `Audit Log & Activity & Session`, `Community 58`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `$id()` connect `Delivery & Md & Hierarchical` to `Configuration & Reference & Status`, `Schedule & Manual & Check`, `Risks & Raid & Md`, `Insights & Burn & Md`, `Defects & Defect & Bug`, `Project & Status & Md`, `User Manual & Architecture & Sync`, `Delivery Matrix & Hierarchy & Edit`, `Reports & Board & Export`, `Widgets & Capture & Screenshot`, `Status & Dashboard & Live`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 35`, `Community 36`, `Community 37`, `Community 40`, `Community 41`, `Community 44`, `Community 45`, `Community 49`, `Community 50`, `Community 51`, `Community 52`, `Community 60`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `notify()` connect `Architecture & Audit & State` to `Readme & State & Block`, `Manual & State & Md`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Readme & Md & Project`, `Team & Capacity & Role`, `Defect Tracker & Bug Lifecycle`, `Audit Log & Activity & Session`?**
