# Graph Report - ProjectPulse  (2026-09-08)

## Corpus Check
- 4 files · ~401,104 words
...
- `renderBackupList()` --calls--> `warn()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 19 → community 13_
- `syncFsDirectory()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 11 → community 13_
- `updateCxoEmailPreview()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 11 → community 19_
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 5 → community 13_
- `updateBulkBar()` --calls--> `$id()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 5 → community 49_
...
Cohesion: 0.03
Nodes (94): addCustomFieldV(), addDep(), addLeaveRow(), addScaffoldRow(), cancelEditFeature(), cancelTplConfirmV(), clearPvFilt(), closeAllFlyouts() (+86 more)

### Community 4 - "Changelog & 2026 & 05"
Cohesion: 0.04
Nodes (90): addDDValueV(), addLog(), addRelease(), applyDashLayout(), applyReportLayout(), applyTemplate(), autoPopulateReport(), buildBoardPackContent() (+82 more)

### Community 5 - "Schedule & Manual & Check"
Cohesion: 0.04
Nodes (75): addCustomFieldV(), addDep(), addLeaveRow(), autoInferCategory(), autoInferRelease(), cancelEditFeature(), cancelTplConfirmV(), clearPvFilt() (+67 more)

### Community 6 - "Readme & Typescript & Entity"
Cohesion: 0.04
Nodes (73): addDep(), addLeaveRow(), cancelTplConfirmV(), clearPvFilt(), closeCmdPalette(), closeCtx(), closeDefectFlyout(), closeDefectLinkDropdown() (+65 more)

### Community 7 - "Scheduler & The & Heuristic"
Cohesion: 0.06
Nodes (50): clearMatrixFilter(), closeRaidFlyout(), deleteFeature(), deleteRaidItem(), deleteRaidItemById(), filterDashboardMetric(), filterDefectsBy(), filterRaid() (+42 more)

### Community 8 - "Overview & Md & Executive"
Cohesion: 0.06
Nodes (49): autoResolveAllSchedulerConflicts(), autoSequenceAssignee(), changeSchedulerWeek(), clearMatrixFilter(), filterDashboardMetric(), filterRaid(), filterTasksByAssignee(), filterTasksByRole() (+41 more)
...
Cohesion: 0.08
Nodes (45): addRelease(), applyDashLayout(), applyReportLayout(), applyTemplate(), buildBoardPackContent(), closeModal(), cycleCwSize(), cycleStandardSize() (+37 more)
...
Cohesion: 0.06
Nodes (40): addEmptyState(), applyPvFilt(), cap(), closeCtx(), createFileBackup(), editReport(), esc(), getFieldType() (+32 more)

### Community 14 - "Defects & Defect & Bug"
Cohesion: 0.07
Nodes (39): addCustomFieldV(), addDDValueV(), addScaffoldRow(), autoPopulateReport(), cancelEditFeature(), closeAllFlyouts(), closeFeatFlyout(), closeTplFlyout() (+31 more)
...
Cohesion: 0.07
Nodes (34): addEmptyState(), addGrid(), addST(), downloadGanttAsHtml(), esc(), formatDateStringFriendly(), getModuleMilestones(), _matrixCellHover() (+26 more)

### Community 17 - "Project & Status & Md"
Cohesion: 0.11
Nodes (32): animateCounter(), applyReportLayout(), buildBoardPackContent(), cancelEditCw(), cycleCwSize(), cycleStandardSize(), deleteReport(), editCustomWidgetCtx() (+24 more)
...
Cohesion: 0.1
Nodes (27): captureAreaAsCanvas(), captureFullFeatureGantt(), captureFullGanttChart(), copyAllShares(), copyChart(), copyWidgetAsImage(), createFileBackup(), error() (+19 more)
...
Cohesion: 0.1
Nodes (26): addDDValueV(), addRelease(), clearProjectState(), createNewGlobalSet(), deleteGlobalSet(), deleteRelease(), enterApp(), loadSample() (+18 more)
...
- **Why does `$id()` connect `Manual & State & Md` to `Architecture & Audit & State`, `Community 34`, `Changelog & 2026 & 05`, `Community 35`, `Community 39`, `Overview & Md & Executive`, `Reports & Board & Md`, `Capacity & Workload & Role`, `Defect Tracker & Bug Lifecycle`, `Community 31`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `$id()` connect `Schedule & Manual & Check` to `Configuration & Reference & Status`, `Community 38`, `Scheduler & The & Heuristic`, `Community 41`, `Delivery & Md & Hierarchical`, `Insights & Burn & Md`, `Team & Capacity & Role`, `Community 49`, `Community 50`, `Project & Status & Md`, `Delivery Matrix & Hierarchy & Edit`, `Community 26`, `Community 27`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `$id()` connect `Readme & Typescript & Entity` to `Community 32`, `Readme & State & Block`, `Risks & Raid & Md`, `Readme & Md & Project`, `Community 42`, `Defects & Defect & Bug`, `Activity & Md & Audit`, `Community 48`, `User Manual & Architecture & Sync`, `Reports & Board & Export`, `Audit Log & Activity & Session`, `Widgets & Capture & Screenshot`?**
