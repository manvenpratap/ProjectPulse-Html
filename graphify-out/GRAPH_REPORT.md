...
## Corpus Check
- 4 files · ~285,548 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1270 nodes · 2869 edges · 54 communities (46 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0679fc37`
...
- `updateBulkBar()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 2 → community 42_
...
Cohesion: 0.06
Nodes (51): addDDValueV(), addRelease(), applyReportLayout(), buildBoardPackContent(), createNewGlobalSet(), cycleCwSize(), cycleStandardSize(), deleteGlobalSet() (+43 more)

### Community 5 - "Schedule & Manual & Check"
Cohesion: 0.06
Nodes (50): addLog(), applyDashLayout(), applyTemplate(), autoPopulateReport(), captureAreaAsCanvas(), captureFullGanttChart(), closeDefectFlyout(), closeMemberFlyout() (+42 more)
...
Cohesion: 0.06
Nodes (35): addRelease(), addScaffoldRow(), cancelEditFeature(), closeAllFlyouts(), closeFeatFlyout(), deleteFeature(), deleteRelease(), duplicateScaffoldRow() (+27 more)
...
Cohesion: 0.09
Nodes (26): addGrid(), addST(), esc(), formatDateStringFriendly(), _matrixCellHover(), _matrixStateChange(), mkCC(), mkCvs() (+18 more)
...
- **Why does `$id()` connect `Architecture & Audit & State` to `Readme & State & Block`, `Changelog & 2026 & 05`, `Schedule & Manual & Check`, `Overview & Md & Executive`, `Community 41`, `Community 42`, `Readme & Md & Project`, `Defects & Defect & Bug`, `Reports & Board & Md`, `Community 48`, `Community 46`, `Project & Status & Md`, `Reports & Board & Export`, `Status & Dashboard & Live`, `Community 26`, `Community 28`, `Community 30`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `$id()` connect `Manual & State & Md` to `Configuration & Reference & Status`, `Scheduler & The & Heuristic`, `Risks & Raid & Md`, `Delivery & Md & Hierarchical`, `Insights & Burn & Md`, `Team & Capacity & Role`, `User Manual & Architecture & Sync`, `Capacity & Workload & Role`, `Defect Tracker & Bug Lifecycle`, `Audit Log & Activity & Session`, `Widgets & Capture & Screenshot`, `Community 27`, `Community 29`, `Community 31`, `Community 33`, `Community 35`, `Community 39`, `Community 43`, `Community 44`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `notify()` connect `Schedule & Manual & Check` to `Readme & State & Block`, `Architecture & Audit & State`, `Changelog & 2026 & 05`, `Readme & Md & Project`, `Defects & Defect & Bug`, `Reports & Board & Md`, `Project & Status & Md`, `Reports & Board & Export`, `Status & Dashboard & Live`, `Community 28`, `Community 30`?**
