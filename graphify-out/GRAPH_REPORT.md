...
## Corpus Check
- 4 files · ~284,249 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1270 nodes · 2869 edges · 72 communities (62 shown, 10 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `63cdcacf`
...
- `renderViewToggle()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 11 → community 27_
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 11 → community 8_
- `syncFsDirectory()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 11 → community 9_
- `updateBulkBar()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 11 → community 56_
- `applyBulkEdit()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 11 → community 10_
...
Cohesion: 0.06
Nodes (47): addNewGUIScreen(), addRelease(), applyWorkflowTemplate(), clearProjectState(), closeFlyout(), closeMemberFlyout(), commitSchedulerSchedule(), confirmDeleteTask() (+39 more)
...
Cohesion: 0.09
Nodes (35): applyDashLayout(), applyReportLayout(), applyTemplate(), buildBoardPackContent(), closeModal(), cycleCwSize(), cycleStandardSize(), deleteReport() (+27 more)

### Community 7 - "Scheduler & The & Heuristic"
Cohesion: 0.09
Nodes (31): addDDValueV(), autoPopulateReport(), captureAreaAsCanvas(), captureFullGanttChart(), closeTplFlyout(), copyAllShares(), copyChart(), copyWidgetAsImage() (+23 more)
...
Cohesion: 0.08
Nodes (27): addScaffoldRow(), createBaselineSnapshot(), createFileBackup(), deleteBaselineSnapshot(), duplicateScaffoldRow(), generateFromScaffold(), generateProjectWorkbook(), getExcelFileBlob() (+19 more)
...
Cohesion: 0.12
Nodes (21): addEmptyState(), closeCtx(), esc(), getModuleMilestones(), _matrixCellHover(), _matrixStateChange(), openAddTask(), openFlyout() (+13 more)
...
Cohesion: 0.17
Nodes (12): enterApp(), initApp(), initDesignSpells(), initGanttResizer(), load(), loadCustomLayouts(), loadRecentProject(), moveViewOrder() (+4 more)
...
Cohesion: 0.22
Nodes (9): deleteFeature(), initFeatGanttResizer(), initFeatScreenSearch(), renderFeatureGantt(), renderFeatureHub(), renderFeatureSwimlane(), setFeatGanttZoom(), setFeatViewMode() (+1 more)
...
Cohesion: 0.67
Nodes (3): renderTeam(), renderTeamPlannerWidgets(), toggleOrgNode()
...
- **Why does `$id()` connect `Delivery & Md & Hierarchical` to `Readme & State & Block`, `Manual & State & Md`, `Schedule & Manual & Check`, `Readme & Typescript & Entity`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Risks & Raid & Md`, `Readme & Md & Project`, `User Manual & Architecture & Sync`, `Status & Dashboard & Live`, `Community 27`, `Community 30`, `Community 33`, `Community 34`, `Community 38`, `Community 39`, `Community 43`, `Community 44`, `Community 51`, `Community 53`, `Community 54`, `Community 56`, `Community 63`, `Community 65`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `$id()` connect `Insights & Burn & Md` to `Configuration & Reference & Status`, `Changelog & 2026 & 05`, `Team & Capacity & Role`, `Defects & Defect & Bug`, `Reports & Board & Md`, `Project & Status & Md`, `Delivery Matrix & Hierarchy & Edit`, `Capacity & Workload & Role`, `Reports & Board & Export`, `Audit Log & Activity & Session`, `Widgets & Capture & Screenshot`, `Community 26`, `Community 28`, `Community 29`, `Community 31`, `Community 32`, `Community 37`, `Community 40`, `Community 41`, `Community 42`, `Community 46`, `Community 47`, `Community 50`, `Community 52`, `Community 57`, `Community 58`, `Community 59`, `Community 61`, `Community 67`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `notify()` connect `Scheduler & The & Heuristic` to `Readme & State & Block`, `Community 34`, `Manual & State & Md`, `Readme & Typescript & Entity`, `Community 39`, `Overview & Md & Executive`, `Risks & Raid & Md`, `Readme & Md & Project`, `Community 43`, `Community 44`, `User Manual & Architecture & Sync`, `Status & Dashboard & Live`, `Community 30`?**
