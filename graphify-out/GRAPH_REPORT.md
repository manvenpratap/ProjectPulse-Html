...
## Corpus Check
- 4 files · ~311,283 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1271 nodes · 2870 edges · 62 communities (54 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `de6dfbc3`
...
- `renderViewToggle()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 13 → community 20_
...
- `syncFsDirectory()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 13 → community 27_
- `updateBulkBar()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 13 → community 47_
- `applyBulkEdit()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 13 → community 16_
...
Cohesion: 0.05
Nodes (70): addNewGUIScreen(), addRelease(), applyDashLayout(), applyReportLayout(), applyTemplate(), applyWorkflowTemplate(), buildBoardPackContent(), closeMemberFlyout() (+62 more)

### Community 3 - "Manual & State & Md"
Cohesion: 0.05
Nodes (57): addDDValueV(), addNewGUIScreen(), addRelease(), applyWorkflowTemplate(), clearProjectState(), closeMemberFlyout(), commitSchedulerSchedule(), createNewGlobalSet() (+49 more)
...
Cohesion: 0.06
Nodes (41): addDDValueV(), autoPopulateReport(), captureAreaAsCanvas(), captureFullGanttChart(), closeRaidFlyout(), closeTplFlyout(), copyAllShares(), copyChart() (+33 more)

### Community 8 - "Overview & Md & Executive"
Cohesion: 0.08
Nodes (40): addLog(), applyDashLayout(), applyTemplate(), autoPopulateReport(), captureAreaAsCanvas(), captureFullFeatureGantt(), captureFullGanttChart(), closeModal() (+32 more)
...
Cohesion: 0.09
Nodes (34): applyReportLayout(), buildBoardPackContent(), commitWhatIfScenario(), cycleCwSize(), cycleStandardSize(), deleteReport(), filterTasksByAssignee(), filterTasksByRole() (+26 more)
...
Cohesion: 0.09
Nodes (23): addScaffoldRow(), duplicateScaffoldRow(), generateFromScaffold(), listBackups(), loadCustomLayouts(), loadScaffoldTemplate(), printContainer(), removeScaffoldRow() (+15 more)
...
Cohesion: 0.14
Nodes (14): applyPvFilt(), cap(), editReport(), getFieldType(), _matrixCellClick(), openDateLegendModal(), openModal(), openNewReport() (+6 more)
...
Cohesion: 0.22
Nodes (9): addCustomFieldV(), cancelEditFeature(), closeAllFlyouts(), closeFeatFlyout(), importScaffoldBulk(), renderCFListV(), renderFieldsView(), renderStdFieldListV() (+1 more)
...
Cohesion: 0.5
Nodes (4): addEmptyState(), getModuleMilestones(), renderMilestoneRoadmap(), setDisplayLevel()
...
- **Why does `$id()` connect `Team & Capacity & Role` to `Readme & State & Block`, `Architecture & Audit & State`, `Readme & Typescript & Entity`, `Scheduler & The & Heuristic`, `Risks & Raid & Md`, `Activity & Md & Audit`, `User Manual & Architecture & Sync`, `Capacity & Workload & Role`, `Defect Tracker & Bug Lifecycle`, `Reports & Board & Export`, `Status & Dashboard & Live`, `Community 27`, `Community 29`, `Community 30`, `Community 32`, `Community 33`, `Community 34`, `Community 36`, `Community 42`, `Community 45`, `Community 46`, `Community 47`, `Community 54`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `$id()` connect `Defects & Defect & Bug` to `Configuration & Reference & Status`, `Manual & State & Md`, `Changelog & 2026 & 05`, `Overview & Md & Executive`, `Readme & Md & Project`, `Delivery & Md & Hierarchical`, `Insights & Burn & Md`, `Project & Status & Md`, `Audit Log & Activity & Session`, `Widgets & Capture & Screenshot`, `Community 26`, `Community 28`, `Community 31`, `Community 35`, `Community 38`, `Community 39`, `Community 44`, `Community 49`, `Community 50`, `Community 52`, `Community 53`, `Community 60`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `save()` connect `Manual & State & Md` to `Configuration & Reference & Status`, `Changelog & 2026 & 05`, `Overview & Md & Executive`, `Community 41`, `Delivery & Md & Hierarchical`, `Insights & Burn & Md`, `Project & Status & Md`, `Widgets & Capture & Screenshot`, `Community 28`, `Community 31`?**
