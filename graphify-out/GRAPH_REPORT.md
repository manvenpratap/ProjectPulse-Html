...
- `syncFsDirectory()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 39 → community 28_
...
Cohesion: 0.01
Nodes (86): activeModal, allDone, anyStarted, blocked, bulkDeleteTasks(), bulkSelectedTasks, c, cache (+78 more)

### Community 3 - "Manual & State & Md"
Cohesion: 0.04
Nodes (89): addDDValueV(), addLog(), addNewGUIScreen(), addRelease(), applyDashLayout(), applyReportLayout(), applyTemplate(), applyWorkflowTemplate() (+81 more)

### Community 4 - "Changelog & 2026 & 05"
Cohesion: 0.04
Nodes (81): addCustomFieldV(), addDep(), addLeaveRow(), cancelEditFeature(), cancelTplConfirmV(), clearPvFilt(), closeAllFlyouts(), closeCmdPalette() (+73 more)
...
Cohesion: 0.05
Nodes (71): addCustomFieldV(), addDep(), addLeaveRow(), autoInferCategory(), autoInferRelease(), cancelTplConfirmV(), clearPvFilt(), closeCmdPalette() (+63 more)

### Community 7 - "Scheduler & The & Heuristic"
Cohesion: 0.06
Nodes (71): addDDValueV(), addLog(), applyBulkEdit(), applyDashLayout(), applyReportLayout(), applyTemplate(), autoPopulateReport(), buildBoardPackContent() (+63 more)

### Community 8 - "Overview & Md & Executive"
Cohesion: 0.06
Nodes (61): addDDValueV(), addLog(), addRelease(), applyBulkEdit(), applyDashLayout(), applyTemplate(), autoPopulateReport(), clearProjectState() (+53 more)

### Community 9 - "Risks & Raid & Md"
Cohesion: 0.05
Nodes (55): autoResolveAllSchedulerConflicts(), autoSequenceAssignee(), changeSchedulerWeek(), clearMatrixFilter(), closeRaidFlyout(), deleteRaidItem(), deleteRaidItemById(), editReport() (+47 more)

### Community 10 - "Readme & Md & Project"
Cohesion: 0.06
Nodes (49): clearMatrixFilter(), closeRaidFlyout(), commitWhatIfScenario(), deleteFeature(), deleteRaidItem(), deleteRaidItemById(), filterDashboardMetric(), filterDefectsBy() (+41 more)

### Community 11 - "Delivery & Md & Hierarchical"
Cohesion: 0.07
Nodes (43): autoResolveAllSchedulerConflicts(), autoSequenceAssignee(), changeSchedulerWeek(), clearMatrixFilter(), closeRaidFlyout(), deleteRaidItem(), deleteRaidItemById(), filterRaid() (+35 more)
...
Cohesion: 0.09
Nodes (23): addScaffoldRow(), cancelEditFeature(), closeAllFlyouts(), closeFeatFlyout(), createBaselineSnapshot(), deleteBaselineSnapshot(), duplicateScaffoldRow(), generateFromScaffold() (+15 more)
...
Cohesion: 0.16
Nodes (18): computeAlerts(), dismissAlert(), dismissAllAlerts(), editReport(), formatRaidDateSince(), getRaidAgeDays(), getRaidDateSince(), nowISO() (+10 more)
...
- **Why does `$id()` connect `Readme & Typescript & Entity` to `Configuration & Reference & Status`, `Community 37`, `Overview & Md & Executive`, `Community 40`, `Readme & Md & Project`, `Insights & Burn & Md`, `Community 47`, `Activity & Md & Audit`, `Community 49`, `Reports & Board & Export`, `Audit Log & Activity & Session`, `Community 26`, `Community 28`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `$id()` connect `Schedule & Manual & Check` to `Community 32`, `Architecture & Audit & State`, `Scheduler & The & Heuristic`, `Risks & Raid & Md`, `Defects & Defect & Bug`, `Project & Status & Md`, `Capacity & Workload & Role`, `Defect Tracker & Bug Lifecycle`, `Widgets & Capture & Screenshot`, `Community 27`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `$id()` connect `Changelog & 2026 & 05` to `Readme & State & Block`, `Community 33`, `Manual & State & Md`, `Community 34`, `Delivery & Md & Hierarchical`, `Team & Capacity & Role`, `Reports & Board & Md`, `User Manual & Architecture & Sync`, `Delivery Matrix & Hierarchy & Edit`?**
