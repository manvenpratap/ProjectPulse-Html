...
## Corpus Check
- 25 files · ~403,212 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 298 nodes · 470 edges · 24 communities (23 shown, 1 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 28 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9f0d0ee6`
...
Cohesion: 0.19
Nodes (14): add_callout(), add_data_table(), add_document_control(), add_footer(), add_horizontal_rule(), add_page_break(), add_schema_table(), add_section_divider() (+6 more)
...
Cohesion: 0.23
Nodes (15): build_umi(), ch_audit(), ch_config(), ch_defects(), ch_delivery(), ch_gantt(), ch_getting_started(), ch_insights() (+7 more)
...
- **Why does `build_fsd()` connect `Architecture & Audit & State` to `Readme & Md & Project`, `Changelog & 2026 & 05`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `build_umi()` connect `Scheduler & The & Heuristic` to `Readme & Md & Project`, `Changelog & 2026 & 05`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `build_pcd()` connect `Readme & Md & Project` to `Changelog & 2026 & 05`?**
