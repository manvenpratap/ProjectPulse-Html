...
- `syncFsDirectory()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 40 → community 19_
...
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 7 → community 16_
...
Cohesion: 0.04
Nodes (82): addDDValueV(), addLog(), addRelease(), applyReportLayout(), applyTemplate(), autoPopulateReport(), buildBoardPackContent(), closeFlyout() (+74 more)
...
Cohesion: 0.04
Nodes (75): addCustomFieldV(), addDep(), addLeaveRow(), cancelTplConfirmV(), clearPvFilt(), closeCmdPalette(), closeCtx(), closeDefectFlyout() (+67 more)
...
Cohesion: 0.06
Nodes (65): addLog(), addNewGUIScreen(), applyBulkEdit(), applyDashLayout(), applyReportLayout(), applyTemplate(), applyWorkflowTemplate(), autoPopulateReport() (+57 more)

### Community 9 - "Risks & Raid & Md"
Cohesion: 0.06
Nodes (49): autoResolveAllSchedulerConflicts(), autoSequenceAssignee(), changeSchedulerWeek(), clearMatrixFilter(), closeRaidFlyout(), deleteRaidItem(), deleteRaidItemById(), filterDashboardMetric() (+41 more)

### Community 10 - "Readme & Md & Project"
Cohesion: 0.07
Nodes (45): cancelEditFeature(), clearMatrixFilter(), closeAllFlyouts(), closeFeatFlyout(), closeRaidFlyout(), deleteFeature(), deleteRaidItem(), deleteRaidItemById() (+37 more)
...
Cohesion: 0.14
Nodes (25): applyBulkEdit(), autoFitCol(), doGridSort(), doSort(), finalizeColOrder(), getGridFiltered(), getGridPK(), getGridSorted() (+17 more)
...
Cohesion: 0.11
Nodes (23): applyDashLayout(), captureAreaAsCanvas(), captureFullFeatureGantt(), captureFullGanttChart(), copyAllShares(), copyChart(), copyWidgetAsImage(), downloadGanttAsHtml() (+15 more)
...
Cohesion: 0.18
Nodes (11): commitWhatIfScenario(), filterTasksByAssignee(), filterTasksByRole(), filterToWeek(), fmtDate(), renderSkeleton(), renderWhatIfSandbox(), resetWhatIfSandbox() (+3 more)
...
- **Why does `$id()` connect `Scheduler & The & Heuristic` to `Configuration & Reference & Status`, `Overview & Md & Executive`, `Community 41`, `Readme & Md & Project`, `Community 42`, `Insights & Burn & Md`, `Community 43`, `Activity & Md & Audit`, `Community 50`, `Delivery Matrix & Hierarchy & Edit`, `User Manual & Architecture & Sync`, `Community 52`, `Reports & Board & Export`, `Status & Dashboard & Live`, `Community 30`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `$id()` connect `Schedule & Manual & Check` to `Community 33`, `Architecture & Audit & State`, `Manual & State & Md`, `Community 34`, `Community 35`, `Community 38`, `Delivery & Md & Hierarchical`, `Defects & Defect & Bug`, `Capacity & Workload & Role`, `Audit Log & Activity & Session`, `Community 28`, `Community 31`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `$id()` connect `Readme & Typescript & Entity` to `Community 32`, `Readme & State & Block`, `Changelog & 2026 & 05`, `Risks & Raid & Md`, `Team & Capacity & Role`, `Reports & Board & Md`, `Project & Status & Md`, `Defect Tracker & Bug Lifecycle`, `Community 26`, `Community 29`?**
