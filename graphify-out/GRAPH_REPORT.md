# Graph Report - ProjectPulse  (2026-08-05)

## Corpus Check
- 4 files · ~306,930 words
...
- `renderViewToggle()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 2 → community 25_
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 2 → community 12_
- `syncFsDirectory()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 2 → community 7_
- `updateBulkBar()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 2 → community 52_
- `applyBulkEdit()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 2 → community 8_
...
Cohesion: 0.05
Nodes (66): addCustomFieldV(), addDep(), addLeaveRow(), cancelTplConfirmV(), clearPvFilt(), closeAllFlyouts(), closeCmdPalette(), closeCtx() (+58 more)
...
Cohesion: 0.07
Nodes (31): addScaffoldRow(), cancelEditFeature(), closeFeatFlyout(), createBaselineSnapshot(), deleteBaselineSnapshot(), deleteFeature(), duplicateScaffoldRow(), generateFromScaffold() (+23 more)

### Community 7 - "Scheduler & The & Heuristic"
Cohesion: 0.08
Nodes (29): addEmptyState(), createFileBackup(), esc(), generateProjectWorkbook(), getExcelFileBlob(), getModuleMilestones(), listBackups(), _matrixCellHover() (+21 more)
...
Cohesion: 0.15
Nodes (21): applyDashLayout(), applyTemplate(), autoPopulateReport(), captureAreaAsCanvas(), captureFullFeatureGantt(), captureFullGanttChart(), closeModal(), closeTplFlyout() (+13 more)
...
Cohesion: 0.18
Nodes (17): applyDashLayout(), applyReportLayout(), buildBoardPackContent(), cycleCwSize(), cycleStandardSize(), getBoardPackHtml(), renderDash(), renderReports() (+9 more)

### Community 22 - "Reports & Board & Export"
Cohesion: 0.18
Nodes (16): closeRaidFlyout(), computeAlerts(), deleteRaidItem(), deleteRaidItemById(), dismissAlert(), dismissAllAlerts(), editReport(), nowISO() (+8 more)

### Community 23 - "Audit Log & Activity & Session"
Cohesion: 0.12
Nodes (16): closeFlyout(), closeMemberFlyout(), commitSchedulerSchedule(), confirmDeleteTask(), deleteMember(), deleteTask(), drawAreaChart(), drawLineChart() (+8 more)
...
Cohesion: 0.2
Nodes (14): applyTemplate(), autoPopulateReport(), closeModal(), closeTplFlyout(), finalizeTplUpdateV(), notify(), openAddMember(), propagateTemplateUpdate() (+6 more)
...
- **Why does `$id()` connect `Architecture & Audit & State` to `Readme & State & Block`, `Schedule & Manual & Check`, `Readme & Typescript & Entity`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Insights & Burn & Md`, `Delivery Matrix & Hierarchy & Edit`, `Defect Tracker & Bug Lifecycle`, `Reports & Board & Export`, `Audit Log & Activity & Session`, `Status & Dashboard & Live`, `Community 26`, `Community 27`, `Community 29`, `Community 32`, `Community 36`, `Community 40`, `Community 44`, `Community 52`, `Community 60`, `Community 61`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `$id()` connect `Risks & Raid & Md` to `Configuration & Reference & Status`, `Changelog & 2026 & 05`, `Readme & Md & Project`, `Delivery & Md & Hierarchical`, `Team & Capacity & Role`, `Reports & Board & Md`, `Activity & Md & Audit`, `Project & Status & Md`, `Capacity & Workload & Role`, `Widgets & Capture & Screenshot`, `Community 28`, `Community 30`, `Community 31`, `Community 33`, `Community 34`, `Community 35`, `Community 39`, `Community 41`, `Community 42`, `Community 43`, `Community 45`, `Community 46`, `Community 50`, `Community 51`, `Community 54`, `Community 55`, `Community 57`, `Community 58`, `Community 63`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `notify()` connect `Community 27` to `Community 32`, `Readme & State & Block`, `Architecture & Audit & State`, `Community 36`, `Readme & Typescript & Entity`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Community 40`, `Insights & Burn & Md`, `Community 44`, `Defect Tracker & Bug Lifecycle`, `Reports & Board & Export`, `Audit Log & Activity & Session`, `Status & Dashboard & Live`, `Community 26`?**
