...
- `copyCxoEmailToClipboard()` --calls--> `warn()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 34 → community 21_
- `syncFsDirectory()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 40 → community 34_
...
- `updateCxoEmailPreview()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 40 → community 21_
...
Cohesion: 0.05
Nodes (69): addCustomFieldV(), addDep(), addLeaveRow(), autoInferCategory(), autoInferRelease(), cancelTplConfirmV(), clearPvFilt(), closeCmdPalette() (+61 more)

### Community 8 - "Overview & Md & Executive"
Cohesion: 0.05
Nodes (65): addDDValueV(), addLog(), addRelease(), applyBulkEdit(), applyDashLayout(), applyTemplate(), autoPopulateReport(), clearProjectState() (+57 more)

### Community 9 - "Risks & Raid & Md"
Cohesion: 0.05
Nodes (56): autoResolveAllSchedulerConflicts(), autoSequenceAssignee(), changeSchedulerWeek(), clearMatrixFilter(), commitWhatIfScenario(), filterDashboardMetric(), filterRaid(), filterTasksByAssignee() (+48 more)
...
Cohesion: 0.08
Nodes (40): animateCounter(), applyPvFilt(), applyReportLayout(), buildBoardPackContent(), cancelEditCw(), cap(), cycleCwSize(), cycleStandardSize() (+32 more)
...
Cohesion: 0.07
Nodes (36): captureAreaAsCanvas(), captureFullFeatureGantt(), captureFullGanttChart(), copyAllShares(), copyChart(), copyWidgetAsImage(), createFileBackup(), downloadGanttAsHtml() (+28 more)
...
Cohesion: 0.12
Nodes (22): closeRaidFlyout(), computeAlerts(), createBaselineSnapshot(), deleteBaselineSnapshot(), deleteRaidItem(), deleteRaidItemById(), dismissAlert(), dismissAllAlerts() (+14 more)
...
Cohesion: 0.19
Nodes (16): computeAlerts(), dismissAlert(), dismissAllAlerts(), formatRaidDateSince(), getRaidAgeDays(), getRaidDateSince(), nowISO(), openRaidModal() (+8 more)
...
Cohesion: 0.25
Nodes (8): cancelEditFeature(), closeAllFlyouts(), closeFeatFlyout(), closeTplFlyout(), finalizeTplUpdateV(), importScaffoldBulk(), propagateTemplateUpdate(), saveFeature()
...
- **Why does `$id()` connect `Scheduler & The & Heuristic` to `Configuration & Reference & Status`, `Community 32`, `Community 34`, `Overview & Md & Executive`, `Community 41`, `Delivery & Md & Hierarchical`, `Insights & Burn & Md`, `Team & Capacity & Role`, `Community 43`, `Project & Status & Md`, `User Manual & Architecture & Sync`, `Community 51`, `Community 49`, `Defect Tracker & Bug Lifecycle`, `Community 29`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `$id()` connect `Readme & Typescript & Entity` to `Community 33`, `Architecture & Audit & State`, `Manual & State & Md`, `Community 35`, `Community 37`, `Readme & Md & Project`, `Reports & Board & Md`, `Delivery Matrix & Hierarchy & Edit`, `Reports & Board & Export`, `Community 28`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `$id()` connect `Changelog & 2026 & 05` to `Readme & State & Block`, `Schedule & Manual & Check`, `Risks & Raid & Md`, `Defects & Defect & Bug`, `Activity & Md & Audit`, `Capacity & Workload & Role`, `Audit Log & Activity & Session`, `Status & Dashboard & Live`, `Community 26`?**
