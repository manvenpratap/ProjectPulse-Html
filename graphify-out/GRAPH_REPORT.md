# Graph Report - ProjectPulse  (2026-08-31)

## Corpus Check
- 4 files · ~390,479 words
...
- `copyCxoEmailToClipboard()` --calls--> `warn()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 32 → community 23_
- `syncFsDirectory()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 38 → community 32_
- `restoreFromFileBackup()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 38 → community 8_
- `updateCxoEmailPreview()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 38 → community 23_
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 7 → community 17_
...
Cohesion: 0.01
Nodes (87): activeModal, allDone, anyStarted, autoFitAllCols(), blocked, bulkDeleteTasks(), bulkSelectedTasks, c (+79 more)

### Community 2 - "Architecture & Audit & State"
Cohesion: 0.01
Nodes (80): activeModal, addNewGUIScreen(), allDone, anyStarted, applyWorkflowTemplate(), autoFitAllCols(), blocked, bulkDeleteTasks() (+72 more)

### Community 3 - "Manual & State & Md"
Cohesion: 0.04
Nodes (84): addCustomFieldV(), addDep(), addLeaveRow(), addScaffoldRow(), cancelTplConfirmV(), clearPvFilt(), closeCmdPalette(), closeCtx() (+76 more)

### Community 4 - "Changelog & 2026 & 05"
Cohesion: 0.04
Nodes (77): addCustomFieldV(), addDep(), addLeaveRow(), cancelEditFeature(), cancelTplConfirmV(), clearPvFilt(), closeAllFlyouts(), closeCmdPalette() (+69 more)
...
Cohesion: 0.05
Nodes (72): addLog(), addNewGUIScreen(), addRelease(), applyReportLayout(), applyTemplate(), applyWorkflowTemplate(), buildBoardPackContent(), closeMemberFlyout() (+64 more)

### Community 7 - "Scheduler & The & Heuristic"
Cohesion: 0.05
Nodes (67): addCustomFieldV(), addDep(), addLeaveRow(), autoInferCategory(), autoInferRelease(), cancelTplConfirmV(), clearPvFilt(), closeCmdPalette() (+59 more)

### Community 8 - "Overview & Md & Executive"
Cohesion: 0.07
Nodes (62): addDDValueV(), addLog(), applyDashLayout(), applyReportLayout(), applyTemplate(), autoPopulateReport(), buildBoardPackContent(), closeDefectFlyout() (+54 more)
...
Cohesion: 0.07
Nodes (43): addDDValueV(), applyDashLayout(), autoPopulateReport(), captureAreaAsCanvas(), captureFullFeatureGantt(), captureFullGanttChart(), closeTplFlyout(), copyAllShares() (+35 more)

### Community 12 - "Insights & Burn & Md"
Cohesion: 0.06
Nodes (42): addDDValueV(), autoPopulateReport(), cancelEditFeature(), captureAreaAsCanvas(), captureFullGanttChart(), closeAllFlyouts(), closeFeatFlyout(), closeTplFlyout() (+34 more)
...
Cohesion: 0.07
Nodes (40): autoResolveAllSchedulerConflicts(), autoSequenceAssignee(), changeSchedulerWeek(), clearMatrixFilter(), filterRaid(), findScheduleConflicts(), generateIntelligentSuggestions(), getSorted() (+32 more)
...
- **Why does `$id()` connect `Scheduler & The & Heuristic` to `Configuration & Reference & Status`, `Community 32`, `Overview & Md & Executive`, `Risks & Raid & Md`, `Community 40`, `Team & Capacity & Role`, `Activity & Md & Audit`, `Project & Status & Md`, `Community 49`, `Community 51`, `Delivery Matrix & Hierarchy & Edit`, `Audit Log & Activity & Session`, `Community 26`, `Community 30`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `$id()` connect `Manual & State & Md` to `Architecture & Audit & State`, `Community 36`, `Schedule & Manual & Check`, `Community 39`, `Community 41`, `Insights & Burn & Md`, `Defects & Defect & Bug`, `Reports & Board & Md`, `Defect Tracker & Bug Lifecycle`, `Widgets & Capture & Screenshot`, `Community 27`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `$id()` connect `Changelog & 2026 & 05` to `Readme & State & Block`, `Community 33`, `Readme & Typescript & Entity`, `Readme & Md & Project`, `Delivery & Md & Hierarchical`, `Community 43`, `User Manual & Architecture & Sync`, `Capacity & Workload & Role`, `Reports & Board & Export`, `Community 28`, `Community 31`?**
