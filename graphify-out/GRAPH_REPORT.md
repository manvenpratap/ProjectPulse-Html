# Graph Report - ProjectPulse  (2026-09-01)

## Corpus Check
- 4 files · ~392,135 words
...
- `copyCxoEmailToClipboard()` --calls--> `warn()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 15 → community 22_
- `syncFsDirectory()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 37 → community 15_
...
- `updateCxoEmailPreview()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 37 → community 22_
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 6 → community 15_
...
Cohesion: 0.01
Nodes (97): activeModal, allDone, anyStarted, autoFitAllCols(), blocked, bulkDeleteTasks(), bulkSelectedTasks, c (+89 more)

### Community 2 - "Architecture & Audit & State"
Cohesion: 0.01
Nodes (87): activeModal, addNewGUIScreen(), allDone, anyStarted, applyWorkflowTemplate(), autoFitAllCols(), blocked, bulkDeleteTasks() (+79 more)

### Community 3 - "Manual & State & Md"
Cohesion: 0.03
Nodes (98): addCustomFieldV(), addDep(), addLeaveRow(), addScaffoldRow(), cancelEditFeature(), cancelTplConfirmV(), clearPvFilt(), closeAllFlyouts() (+90 more)

### Community 4 - "Changelog & 2026 & 05"
Cohesion: 0.04
Nodes (94): addCustomFieldV(), addDDValueV(), addLog(), addRelease(), applyReportLayout(), applyTemplate(), autoPopulateReport(), buildBoardPackContent() (+86 more)

### Community 5 - "Schedule & Manual & Check"
Cohesion: 0.04
Nodes (80): addDep(), addLeaveRow(), applyPvFilt(), cancelTplConfirmV(), cap(), clearPvFilt(), closeCmdPalette(), closeCtx() (+72 more)

### Community 6 - "Readme & Typescript & Entity"
Cohesion: 0.05
Nodes (74): addCustomFieldV(), addDep(), addLeaveRow(), autoInferCategory(), autoInferRelease(), cancelEditFeature(), cancelTplConfirmV(), clearPvFilt() (+66 more)

### Community 7 - "Scheduler & The & Heuristic"
Cohesion: 0.06
Nodes (71): addDDValueV(), addLog(), addRelease(), applyDashLayout(), applyReportLayout(), applyTemplate(), autoPopulateReport(), closeMemberFlyout() (+63 more)
...
Cohesion: 0.06
Nodes (48): autoResolveAllSchedulerConflicts(), autoSequenceAssignee(), changeSchedulerWeek(), clearMatrixFilter(), commitWhatIfScenario(), filterRaid(), findScheduleConflicts(), fmtDate() (+40 more)
...
Cohesion: 0.07
Nodes (42): clearMatrixFilter(), closeRaidFlyout(), deleteFeature(), deleteRaidItem(), deleteRaidItemById(), filterRaid(), formatRaidDateSince(), getRaidAgeDays() (+34 more)

### Community 13 - "Team & Capacity & Role"
Cohesion: 0.06
Nodes (41): addEmptyState(), addGrid(), addST(), buildBoardPackContent(), closeCtx(), esc(), formatDateStringFriendly(), generateFullBoardPackHtml() (+33 more)

### Community 14 - "Defects & Defect & Bug"
Cohesion: 0.07
Nodes (38): applyDashLayout(), captureAreaAsCanvas(), captureFullFeatureGantt(), captureFullGanttChart(), copyAllShares(), copyChart(), copyWidgetAsImage(), createFileBackup() (+30 more)
...
Cohesion: 0.11
Nodes (30): animateCounter(), applyReportLayout(), buildBoardPackContent(), cancelEditCw(), cycleCwSize(), cycleStandardSize(), editCustomWidgetCtx(), editCw() (+22 more)
...
Cohesion: 0.18
Nodes (16): cancelEditCw(), editCustomWidgetCtx(), editCw(), moveDashSec(), moveRptSec(), openDashBuilder(), openReportBuilder(), removePvFilt() (+8 more)
...
Cohesion: 0.24
Nodes (10): deleteReport(), filterDashboardMetric(), filterTasksByAssignee(), filterTasksByRole(), filterToWeek(), renderSkeleton(), renderSnapshotsList(), saveReport() (+2 more)
...
- **Why does `$id()` connect `Readme & Typescript & Entity` to `Configuration & Reference & Status`, `Community 38`, `Community 39`, `Overview & Md & Executive`, `Community 41`, `Readme & Md & Project`, `Insights & Burn & Md`, `Reports & Board & Md`, `Community 47`, `Community 49`, `User Manual & Architecture & Sync`, `Activity & Md & Audit`, `Reports & Board & Export`, `Community 26`, `Community 27`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `$id()` connect `Manual & State & Md` to `Readme & State & Block`, `Scheduler & The & Heuristic`, `Delivery & Md & Hierarchical`, `Team & Capacity & Role`, `Delivery Matrix & Hierarchy & Edit`, `Capacity & Workload & Role`, `Community 28`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `$id()` connect `Schedule & Manual & Check` to `Community 32`, `Architecture & Audit & State`, `Community 35`, `Changelog & 2026 & 05`, `Risks & Raid & Md`, `Defects & Defect & Bug`, `Project & Status & Md`, `Defect Tracker & Bug Lifecycle`, `Widgets & Capture & Screenshot`, `Community 31`?**
