...
- `copyCxoEmailToClipboard()` --calls--> `warn()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 28 → community 22_
- `syncFsDirectory()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 21 → community 28_
- `restoreFromFileBackup()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 21 → community 6_
- `updateCxoEmailPreview()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 21 → community 22_
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 8 → community 23_
...
Cohesion: 0.04
Nodes (84): addCustomFieldV(), addDep(), addLeaveRow(), addScaffoldRow(), cancelEditFeature(), cancelTplConfirmV(), clearPvFilt(), closeAllFlyouts() (+76 more)
...
Cohesion: 0.06
Nodes (70): addDDValueV(), addLog(), addRelease(), animateCounter(), applyBulkEdit(), applyDashLayout(), applyReportLayout(), applyTemplate() (+62 more)
...
Cohesion: 0.06
Nodes (48): autoResolveAllSchedulerConflicts(), autoSequenceAssignee(), changeSchedulerWeek(), clearMatrixFilter(), filterDashboardMetric(), filterRaid(), filterTasksByAssignee(), filterTasksByRole() (+40 more)
...
Cohesion: 0.07
Nodes (32): addEmptyState(), addGrid(), addST(), esc(), formatDateStringFriendly(), generateFullBoardPackHtml(), getModuleMilestones(), _matrixCellHover() (+24 more)
...
Cohesion: 0.09
Nodes (25): addCustomFieldV(), addScaffoldRow(), cancelEditFeature(), closeAllFlyouts(), closeFeatFlyout(), duplicateScaffoldRow(), generateFromScaffold(), importScaffoldBulk() (+17 more)
...
Cohesion: 0.13
Nodes (22): cancelEditCw(), cycleCwSize(), editCustomWidgetCtx(), editCw(), moveDashSec(), moveRptSec(), openReportBuilder(), removePvFilt() (+14 more)

### Community 27 - "Community 27"
Cohesion: 0.1
Nodes (21): applyPvFilt(), cap(), createBaselineSnapshot(), deleteBaselineSnapshot(), editReport(), getFieldType(), _matrixCellClick(), openDashBuilder() (+13 more)

### Community 28 - "Community 28"
Cohesion: 0.12
Nodes (20): createFileBackup(), esc(), listBackups(), loadCustomLayouts(), openAddTask(), openFlyout(), openReleaseAssetsFlyout(), openServerWorkflowFlyout() (+12 more)
...
Cohesion: 0.12
Nodes (18): clearProjectState(), enterApp(), initApp(), initDesignSpells(), initGanttResizer(), load(), loadCustomLayouts(), loadRecentProject() (+10 more)
...
- **Why does `$id()` connect `Overview & Md & Executive` to `Configuration & Reference & Status`, `Community 35`, `Readme & Typescript & Entity`, `Community 38`, `Community 42`, `Delivery & Md & Hierarchical`, `Insights & Burn & Md`, `Reports & Board & Md`, `Community 49`, `Community 50`, `Delivery Matrix & Hierarchy & Edit`, `Reports & Board & Export`, `Audit Log & Activity & Session`, `Status & Dashboard & Live`, `Community 28`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `$id()` connect `Manual & State & Md` to `Community 32`, `Architecture & Audit & State`, `Community 36`, `Schedule & Manual & Check`, `Community 39`, `Risks & Raid & Md`, `Team & Capacity & Role`, `Activity & Md & Audit`, `Community 26`, `Community 27`, `Community 31`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `$id()` connect `Changelog & 2026 & 05` to `Readme & State & Block`, `Community 34`, `Community 33`, `Scheduler & The & Heuristic`, `Community 40`, `Readme & Md & Project`, `Defects & Defect & Bug`, `Project & Status & Md`, `User Manual & Architecture & Sync`, `Capacity & Workload & Role`, `Community 30`?**
