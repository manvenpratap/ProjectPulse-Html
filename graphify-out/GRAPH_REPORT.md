...
## Corpus Check
- 4 files · ~284,255 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1270 nodes · 2869 edges · 56 communities (48 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3822b0cd`
...
- `renderViewToggle()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 3 → community 27_
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 3 → community 5_
- `updateBulkBar()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 3 → community 43_
...
- `submitComment()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 3 → community 38_
...
Cohesion: 0.05
Nodes (43): addEmptyState(), applyPvFilt(), cap(), createBaselineSnapshot(), createFileBackup(), deleteBaselineSnapshot(), editReport(), esc() (+35 more)
...
Cohesion: 0.07
Nodes (30): addScaffoldRow(), cancelEditFeature(), closeFeatFlyout(), closeTplFlyout(), deleteFeature(), duplicateScaffoldRow(), finalizeTplUpdateV(), generateFromScaffold() (+22 more)
...
Cohesion: 0.12
Nodes (16): closeDefectFlyout(), closeMemberFlyout(), commitSchedulerSchedule(), deleteMember(), drawAreaChart(), drawLineChart(), drawVBar(), drawVelocityLine() (+8 more)
...
Cohesion: 0.24
Nodes (11): applyDashLayout(), applyTemplate(), autoPopulateReport(), closeModal(), notify(), openAddMember(), reconstructProjectFromBuffer(), restoreFromFileBackup() (+3 more)
...
- **Why does `$id()` connect `Manual & State & Md` to `Readme & State & Block`, `Schedule & Manual & Check`, `Scheduler & The & Heuristic`, `Risks & Raid & Md`, `Readme & Md & Project`, `User Manual & Architecture & Sync`, `Defect Tracker & Bug Lifecycle`, `Reports & Board & Export`, `Status & Dashboard & Live`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 31`, `Community 33`, `Community 38`, `Community 42`, `Community 43`, `Community 48`, `Community 50`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `$id()` connect `Architecture & Audit & State` to `Configuration & Reference & Status`, `Community 32`, `Community 37`, `Readme & Typescript & Entity`, `Overview & Md & Executive`, `Delivery & Md & Hierarchical`, `Insights & Burn & Md`, `Team & Capacity & Role`, `Community 45`, `Community 47`, `Reports & Board & Md`, `Activity & Md & Audit`, `Delivery Matrix & Hierarchy & Edit`, `Capacity & Workload & Role`, `Audit Log & Activity & Session`, `Widgets & Capture & Screenshot`, `Community 30`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `notify()` connect `Community 33` to `Readme & State & Block`, `Manual & State & Md`, `Schedule & Manual & Check`, `Community 38`, `Risks & Raid & Md`, `Readme & Md & Project`, `User Manual & Architecture & Sync`, `Defect Tracker & Bug Lifecycle`, `Status & Dashboard & Live`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 31`?**
