...
- `renderViewToggle()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 9 → community 28_
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 9 → community 6_
- `syncFsDirectory()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 9 → community 42_
...
Cohesion: 0.13
Nodes (21): closeCtx(), esc(), formatDateStringFriendly(), _matrixCellHover(), _matrixStateChange(), openAddTask(), openFlyout(), openReleaseAssetsFlyout() (+13 more)
...
Cohesion: 0.18
Nodes (18): applyReportLayout(), buildBoardPackContent(), cycleCwSize(), cycleStandardSize(), getBoardPackHtml(), renderDash(), renderReports(), resetDashLayout() (+10 more)

### Community 20 - "Capacity & Workload & Role"
Cohesion: 0.12
Nodes (18): commitWhatIfScenario(), deleteReport(), filterTasksByAssignee(), filterTasksByRole(), filterToWeek(), openEwsModal(), renderOverviewView(), renderSkeleton() (+10 more)

### Community 21 - "Defect Tracker & Bug Lifecycle"
Cohesion: 0.12
Nodes (18): addRelease(), addScaffoldRow(), deleteRelease(), duplicateScaffoldRow(), generateFromScaffold(), loadScaffoldTemplate(), removeScaffoldRow(), renderAdminView() (+10 more)
...
Cohesion: 0.15
Nodes (17): applyDashLayout(), applyTemplate(), autoPopulateReport(), closeModal(), closeTplFlyout(), finalizeTplUpdateV(), generateFullBoardPackHtml(), notify() (+9 more)

### Community 24 - "Widgets & Capture & Screenshot"
Cohesion: 0.15
Nodes (17): commitSchedulerSchedule(), deleteMember(), drawAreaChart(), drawVBar(), fmtDate(), getModuleMilestones(), loadSample(), markAllGUIStepsDone() (+9 more)
...
Cohesion: 0.14
Nodes (16): addLog(), closeMemberFlyout(), commitSchedulerSchedule(), deleteMember(), drawAreaChart(), drawVBar(), render(), saveInlineSettings() (+8 more)

### Community 28 - "Community 28"
Cohesion: 0.14
Nodes (14): clearProjectState(), enterApp(), initApp(), initDesignSpells(), initGanttResizer(), load(), loadCustomLayouts(), loadRecentProject() (+6 more)
...
- **Why does `$id()` connect `Risks & Raid & Md` to `Readme & State & Block`, `Schedule & Manual & Check`, `Readme & Typescript & Entity`, `Scheduler & The & Heuristic`, `Readme & Md & Project`, `Insights & Burn & Md`, `Project & Status & Md`, `Delivery Matrix & Hierarchy & Edit`, `Capacity & Workload & Role`, `Audit Log & Activity & Session`, `Widgets & Capture & Screenshot`, `Status & Dashboard & Live`, `Community 28`, `Community 31`, `Community 38`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 45`, `Community 46`, `Community 49`, `Community 52`, `Community 54`, `Community 55`, `Community 56`, `Community 57`, `Community 62`, `Community 63`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `$id()` connect `Architecture & Audit & State` to `Configuration & Reference & Status`, `Changelog & 2026 & 05`, `Overview & Md & Executive`, `Team & Capacity & Role`, `Defects & Defect & Bug`, `Reports & Board & Md`, `User Manual & Architecture & Sync`, `Defect Tracker & Bug Lifecycle`, `Reports & Board & Export`, `Community 26`, `Community 27`, `Community 29`, `Community 30`, `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 40`, `Community 51`, `Community 58`, `Community 60`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `notify()` connect `Audit Log & Activity & Session` to `Readme & State & Block`, `Readme & Typescript & Entity`, `Scheduler & The & Heuristic`, `Readme & Md & Project`, `Insights & Burn & Md`, `Project & Status & Md`, `Delivery Matrix & Hierarchy & Edit`, `Capacity & Workload & Role`, `Widgets & Capture & Screenshot`, `Status & Dashboard & Live`, `Community 28`, `Community 31`, `Community 38`, `Community 41`, `Community 42`, `Community 43`, `Community 45`, `Community 46`, `Community 49`, `Community 56`?**
