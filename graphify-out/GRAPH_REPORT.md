...
- `renderViewToggle()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 3 → community 25_
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 3 → community 8_
- `updateBulkBar()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 3 → community 47_
- `applyBulkEdit()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 3 → community 9_
- `submitComment()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 3 → community 2_
...
Cohesion: 0.05
Nodes (68): addLog(), applyDashLayout(), applyReportLayout(), applyTemplate(), autoPopulateReport(), buildBoardPackContent(), closeFlyout(), closeMemberFlyout() (+60 more)

### Community 3 - "Manual & State & Md"
Cohesion: 0.05
Nodes (65): addCustomFieldV(), addDep(), addLeaveRow(), cancelTplConfirmV(), clearPvFilt(), closeAllFlyouts(), closeCmdPalette(), closeCtx() (+57 more)
...
Cohesion: 0.12
Nodes (17): addEmptyState(), esc(), getModuleMilestones(), _matrixCellHover(), _matrixStateChange(), openAddTask(), openFlyout(), openReleaseAssetsFlyout() (+9 more)
...
Cohesion: 0.18
Nodes (11): createBaselineSnapshot(), deleteBaselineSnapshot(), editReport(), openNewReport(), openSettings(), renderAdminContent(), renderSettings(), renderSettingsBaselines() (+3 more)
...
- **Why does `$id()` connect `Manual & State & Md` to `Readme & State & Block`, `Architecture & Audit & State`, `Community 34`, `Readme & Typescript & Entity`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Risks & Raid & Md`, `Community 47`, `Delivery Matrix & Hierarchy & Edit`, `Capacity & Workload & Role`, `Community 54`, `Reports & Board & Export`, `Community 56`, `Status & Dashboard & Live`, `Community 26`, `Widgets & Capture & Screenshot`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `$id()` connect `Readme & Md & Project` to `Configuration & Reference & Status`, `Schedule & Manual & Check`, `Delivery & Md & Hierarchical`, `Insights & Burn & Md`, `Defects & Defect & Bug`, `Reports & Board & Md`, `Activity & Md & Audit`, `Project & Status & Md`, `Defect Tracker & Bug Lifecycle`, `Audit Log & Activity & Session`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 37`, `Community 38`, `Community 39`, `Community 40`, `Community 41`, `Community 45`, `Community 46`, `Community 49`, `Community 50`, `Community 51`, `Community 52`, `Community 58`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `notify()` connect `Architecture & Audit & State` to `Readme & State & Block`, `Manual & State & Md`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Risks & Raid & Md`, `Delivery Matrix & Hierarchy & Edit`, `Capacity & Workload & Role`, `Reports & Board & Export`, `Widgets & Capture & Screenshot`, `Status & Dashboard & Live`, `Community 26`?**
