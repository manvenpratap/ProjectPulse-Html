...
## Corpus Check
- 4 files · ~283,519 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1270 nodes · 2869 edges · 71 communities (62 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ef99f538`
...
- `renderViewToggle()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 13 → community 24_
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 13 → community 25_
...
Cohesion: 0.05
Nodes (58): addLog(), applyDashLayout(), applyTemplate(), autoPopulateReport(), captureAreaAsCanvas(), captureFullGanttChart(), closeDefectFlyout(), closeMemberFlyout() (+50 more)
...
Cohesion: 0.07
Nodes (37): addDDValueV(), addNewGUIScreen(), addRelease(), applyWorkflowTemplate(), createNewGlobalSet(), deleteGlobalSet(), deleteRelease(), drawAgeBars() (+29 more)

### Community 7 - "Scheduler & The & Heuristic"
Cohesion: 0.1
Nodes (32): applyReportLayout(), buildBoardPackContent(), cancelEditCw(), cycleCwSize(), cycleStandardSize(), editCustomWidgetCtx(), editCw(), getBoardPackHtml() (+24 more)
...
Cohesion: 0.09
Nodes (26): addEmptyState(), createFileBackup(), esc(), generateProjectWorkbook(), getExcelFileBlob(), getModuleMilestones(), listBackups(), _matrixCellHover() (+18 more)

### Community 10 - "Readme & Md & Project"
Cohesion: 0.08
Nodes (26): addRelease(), addScaffoldRow(), deleteFeature(), deleteRelease(), duplicateScaffoldRow(), generateFromScaffold(), initFeatScreenSearch(), loadScaffoldTemplate() (+18 more)
...
Cohesion: 0.1
Nodes (25): addLeaveRow(), clearPvFilt(), closeCmdPalette(), closeEwsModal(), drawProgressRing(), $id(), initFeatGanttResizer(), openBulkDD() (+17 more)
...
Cohesion: 0.13
Nodes (15): applyPvFilt(), cap(), editReport(), getFieldType(), _matrixCellClick(), openDashBuilder(), openDateLegendModal(), openModal() (+7 more)
...
Cohesion: 0.17
Nodes (12): addCustomFieldV(), closeAllFlyouts(), closeTplFlyout(), finalizeTplUpdateV(), importScaffoldBulk(), openRaidModal(), propagateTemplateUpdate(), renderCFListV() (+4 more)
...
Cohesion: 0.67
Nodes (3): addDep(), refreshDepUI(), removeDep()
...
- **Why does `$id()` connect `Team & Capacity & Role` to `Readme & State & Block`, `Architecture & Audit & State`, `Schedule & Manual & Check`, `Readme & Typescript & Entity`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Risks & Raid & Md`, `Activity & Md & Audit`, `Widgets & Capture & Screenshot`, `Status & Dashboard & Live`, `Community 26`, `Community 29`, `Community 32`, `Community 36`, `Community 40`, `Community 41`, `Community 43`, `Community 49`, `Community 50`, `Community 53`, `Community 54`, `Community 55`, `Community 63`, `Community 64`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `$id()` connect `Insights & Burn & Md` to `Configuration & Reference & Status`, `Changelog & 2026 & 05`, `Readme & Md & Project`, `Delivery & Md & Hierarchical`, `Reports & Board & Md`, `Project & Status & Md`, `Delivery Matrix & Hierarchy & Edit`, `Capacity & Workload & Role`, `Defect Tracker & Bug Lifecycle`, `Reports & Board & Export`, `Audit Log & Activity & Session`, `Community 27`, `Community 28`, `Community 30`, `Community 31`, `Community 33`, `Community 34`, `Community 35`, `Community 39`, `Community 42`, `Community 44`, `Community 45`, `Community 51`, `Community 56`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 70`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `notify()` connect `Architecture & Audit & State` to `Community 32`, `Readme & State & Block`, `Readme & Typescript & Entity`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Risks & Raid & Md`, `Community 43`, `Activity & Md & Audit`, `Widgets & Capture & Screenshot`, `Status & Dashboard & Live`, `Community 26`, `Community 29`?**
