...
## Corpus Check
- 4 files · ~310,507 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1270 nodes · 2869 edges · 52 communities (44 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a14f6dce`
...
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 2 → community 14_
...
- `updateBulkBar()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 2 → community 39_
...
Cohesion: 0.05
Nodes (55): addDDValueV(), addNewGUIScreen(), addRelease(), applyWorkflowTemplate(), closeFlyout(), closeMemberFlyout(), commitSchedulerSchedule(), confirmDeleteTask() (+47 more)
...
Cohesion: 0.07
Nodes (39): applyDashLayout(), applyReportLayout(), applyTemplate(), buildBoardPackContent(), closeModal(), commitWhatIfScenario(), cycleStandardSize(), deleteReport() (+31 more)

### Community 9 - "Risks & Raid & Md"
Cohesion: 0.07
Nodes (32): addEmptyState(), createFileBackup(), esc(), generateProjectWorkbook(), getExcelFileBlob(), getModuleMilestones(), listBackups(), _matrixCellHover() (+24 more)
...
Cohesion: 0.1
Nodes (28): addLog(), autoPopulateReport(), captureAreaAsCanvas(), captureFullGanttChart(), closeTplFlyout(), copyAllShares(), copyChart(), copyWidgetAsImage() (+20 more)
...
Cohesion: 0.11
Nodes (25): applyPvFilt(), cancelEditCw(), cap(), cycleCwSize(), editCustomWidgetCtx(), editCw(), getFieldType(), _matrixCellClick() (+17 more)
...
Cohesion: 0.11
Nodes (21): addNewGUIScreen(), applyWorkflowTemplate(), closeMemberFlyout(), commitSchedulerSchedule(), deleteMember(), drawAreaChart(), drawVBar(), fmtDate() (+13 more)
...
Cohesion: 0.16
Nodes (19): applyReportLayout(), buildBoardPackContent(), cycleCwSize(), cycleStandardSize(), getBoardPackHtml(), getModuleMilestones(), renderDash(), renderReports() (+11 more)
...
- **Why does `$id()` connect `Architecture & Audit & State` to `Readme & State & Block`, `Changelog & 2026 & 05`, `Community 39`, `Scheduler & The & Heuristic`, `Risks & Raid & Md`, `Overview & Md & Executive`, `Delivery & Md & Hierarchical`, `Insights & Burn & Md`, `Readme & Md & Project`, `Defects & Defect & Bug`, `Community 47`, `Community 46`, `Status & Dashboard & Live`, `Community 27`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `$id()` connect `Manual & State & Md` to `Configuration & Reference & Status`, `Readme & Typescript & Entity`, `Team & Capacity & Role`, `Activity & Md & Audit`, `Project & Status & Md`, `User Manual & Architecture & Sync`, `Delivery Matrix & Hierarchy & Edit`, `Defect Tracker & Bug Lifecycle`, `Reports & Board & Export`, `Audit Log & Activity & Session`, `Widgets & Capture & Screenshot`, `Community 26`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 34`, `Community 38`, `Community 42`, `Community 43`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `notify()` connect `Delivery & Md & Hierarchical` to `Readme & State & Block`, `Architecture & Audit & State`, `Changelog & 2026 & 05`, `Overview & Md & Executive`, `Risks & Raid & Md`, `Readme & Md & Project`, `Insights & Burn & Md`, `Defects & Defect & Bug`, `Status & Dashboard & Live`, `Community 27`?**
