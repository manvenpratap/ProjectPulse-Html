# Graph Report - ProjectPulse  (2026-06-25)

## Corpus Check
- 3 files · ~229,278 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 73 nodes · 70 edges · 7 communities
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f75f906b`
...
1. `12 Change Log Baseline` - 20 edges
...
Cohesion: 0.14
Nodes (13): 1. Codebase Architecture & File Map, 4. Core Function Registry, 5. Storage & Persistence Tiers, 7. Change Log (Milestones), 8. Modular Documentation Build System, A. Dynamic Configuration Extraction, A. View Rendering (Orchestration & Target Containers), B. CRUD Operations (+5 more)
...
## Knowledge Gaps
- **51 isolated node(s):** `State Storage & Memory Registry`, `State Mutation & Splicing Side Effects`, `A. Scheduling Engine (`recalcDatesAndStatus` & `recalcGUIScreen`)`, `B. Dashboard / Analytics Cache (`buildDashCache`)`, `C. Persistence & Backup Tier` (+46 more)
  These have ≤1 connection - possible missing edges or undocumented components.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `ProjectPulse — High-Density AI Context Pack` connect `Readme & State & Block` to `Manual & State & Md`, `Schedule & Manual & Check`, `Readme & Typescript & Entity`?**
  _High betweenness centrality (0.173) - this node is a cross-community bridge._
- **Why does `3. Entity Schemas` connect `Manual & State & Md` to `Readme & State & Block`?**
