...
## Corpus Check
- 4 files · ~272,776 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1270 nodes · 2869 edges · 64 communities (55 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ee5fe590`
...
- `updateBulkBar()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 2 → community 49_
...
- `submitComment()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 2 → community 4_
...
Cohesion: 0.05
Nodes (65): addCustomFieldV(), addDep(), addLeaveRow(), cancelEditFeature(), cancelTplConfirmV(), clearPvFilt(), closeAllFlyouts(), closeCmdPalette() (+57 more)

### Community 3 - "Manual & State & Md"
Cohesion: 0.06
Nodes (52): addDDValueV(), addRelease(), applyReportLayout(), buildBoardPackContent(), createNewGlobalSet(), cycleCwSize(), cycleStandardSize(), deleteGlobalSet() (+44 more)

### Community 4 - "Changelog & 2026 & 05"
Cohesion: 0.06
Nodes (49): addLog(), applyDashLayout(), applyTemplate(), autoPopulateReport(), captureAreaAsCanvas(), captureFullGanttChart(), closeDefectFlyout(), closeFlyout() (+41 more)
...
Cohesion: 0.09
Nodes (24): createBaselineSnapshot(), createFileBackup(), deleteBaselineSnapshot(), editReport(), generateProjectWorkbook(), getExcelFileBlob(), listBackups(), _matrixCellClick() (+16 more)
...
Cohesion: 0.12
Nodes (21): addLog(), applyTemplate(), closeModal(), commitSchedulerSchedule(), deleteMember(), drawAreaChart(), drawVBar(), getModuleMilestones() (+13 more)
...
Cohesion: 0.43
Nodes (7): captureAreaAsCanvas(), captureFullFeatureGantt(), captureFullGanttChart(), copyAllShares(), copyChart(), copyWidgetAsImage(), error()
...
- **Why does `$id()` connect `Architecture & Audit & State` to `Readme & State & Block`, `Community 26`, `Changelog & 2026 & 05`, `Manual & State & Md`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Insights & Burn & Md`, `Team & Capacity & Role`, `Activity & Md & Audit`, `Community 49`, `Capacity & Workload & Role`, `Audit Log & Activity & Session`, `Community 57`, `Community 58`, `Community 27`, `Community 29`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `$id()` connect `Risks & Raid & Md` to `Configuration & Reference & Status`, `Readme & Typescript & Entity`, `Readme & Md & Project`, `Delivery & Md & Hierarchical`, `Defects & Defect & Bug`, `Project & Status & Md`, `User Manual & Architecture & Sync`, `Defect Tracker & Bug Lifecycle`, `Reports & Board & Export`, `Widgets & Capture & Screenshot`, `Status & Dashboard & Live`, `Community 28`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 35`, `Community 37`, `Community 38`, `Community 39`, `Community 42`, `Community 43`, `Community 46`, `Community 47`, `Community 50`, `Community 51`, `Community 52`, `Community 53`, `Community 59`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `notify()` connect `Changelog & 2026 & 05` to `Readme & State & Block`, `Architecture & Audit & State`, `Manual & State & Md`, `Overview & Md & Executive`, `Insights & Burn & Md`, `Team & Capacity & Role`, `Activity & Md & Audit`, `Capacity & Workload & Role`, `Audit Log & Activity & Session`, `Community 27`, `Community 29`?**
