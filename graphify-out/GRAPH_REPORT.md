...
## Corpus Check
- 5 files · ~498,930 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1270 nodes · 2869 edges · 53 communities (46 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fc7cb230`
...
- `applyBulkEdit()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 3 → community 14_
...
Cohesion: 0.05
Nodes (80): addDDValueV(), addLog(), addRelease(), applyDashLayout(), applyReportLayout(), applyTemplate(), autoPopulateReport(), buildBoardPackContent() (+72 more)

### Community 3 - "Manual & State & Md"
Cohesion: 0.05
Nodes (67): addCustomFieldV(), addDep(), addLeaveRow(), cancelTplConfirmV(), clearPvFilt(), closeCmdPalette(), closeDefectFlyout(), closeDefectLinkDropdown() (+59 more)
...
Cohesion: 0.1
Nodes (28): addEmptyState(), closeCtx(), esc(), formatDateStringFriendly(), generateFullBoardPackHtml(), getModuleMilestones(), _matrixCellHover(), _matrixStateChange() (+20 more)
...
Cohesion: 0.08
Nodes (27): addScaffoldRow(), cancelEditFeature(), closeAllFlyouts(), closeFeatFlyout(), closeTplFlyout(), duplicateScaffoldRow(), finalizeTplUpdateV(), generateFromScaffold() (+19 more)
...
- **Why does `$id()` connect `Manual & State & Md` to `Community 32`, `Readme & State & Block`, `Architecture & Audit & State`, `Scheduler & The & Heuristic`, `Risks & Raid & Md`, `Community 42`, `Insights & Burn & Md`, `Team & Capacity & Role`, `Defects & Defect & Bug`, `Community 47`, `Capacity & Workload & Role`, `Reports & Board & Export`, `Audit Log & Activity & Session`, `Status & Dashboard & Live`, `Community 28`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `$id()` connect `Changelog & 2026 & 05` to `Configuration & Reference & Status`, `Readme & Typescript & Entity`, `Overview & Md & Executive`, `Readme & Md & Project`, `Delivery & Md & Hierarchical`, `Reports & Board & Md`, `Project & Status & Md`, `Delivery Matrix & Hierarchy & Edit`, `Defect Tracker & Bug Lifecycle`, `Widgets & Capture & Screenshot`, `Community 26`, `Community 27`, `Community 29`, `Community 30`, `Community 34`, `Community 36`, `Community 39`, `Community 44`, `Community 45`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `save()` connect `Architecture & Audit & State` to `Community 32`, `Readme & State & Block`, `Manual & State & Md`, `Community 38`, `Scheduler & The & Heuristic`, `Team & Capacity & Role`, `Defects & Defect & Bug`, `Capacity & Workload & Role`, `Audit Log & Activity & Session`, `Status & Dashboard & Live`, `Community 31`?**
