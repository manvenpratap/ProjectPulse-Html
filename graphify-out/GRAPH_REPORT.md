# Graph Report - ProjectPulse  (2026-08-21)

## Corpus Check
- 4 files · ~340,572 words
...
- `renderBackupList()` --calls--> `warn()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 30 → community 3_
- `copyCxoEmailToClipboard()` --calls--> `warn()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 30 → community 25_
- `syncFsDirectory()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 36 → community 3_
- `restoreFromFileBackup()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 36 → community 4_
- `updateCxoEmailPreview()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 36 → community 25_
...
Cohesion: 0.04
Nodes (79): addDep(), addLeaveRow(), autoInferCategory(), autoInferRelease(), cancelTplConfirmV(), clearPvFilt(), closeCmdPalette(), closeCtx() (+71 more)

### Community 4 - "Changelog & 2026 & 05"
Cohesion: 0.05
Nodes (78): addDDValueV(), addLog(), addRelease(), animateCounter(), applyDashLayout(), applyReportLayout(), applyTemplate(), autoPopulateReport() (+70 more)
...
Cohesion: 0.05
Nodes (72): addCustomFieldV(), addDep(), addLeaveRow(), cancelTplConfirmV(), clearPvFilt(), closeCmdPalette(), closeCtx(), closeDefectFlyout() (+64 more)

### Community 7 - "Scheduler & The & Heuristic"
Cohesion: 0.05
Nodes (61): addDDValueV(), addRelease(), applyDashLayout(), applyReportLayout(), applyTemplate(), buildBoardPackContent(), closeModal(), createNewGlobalSet() (+53 more)

### Community 8 - "Overview & Md & Executive"
Cohesion: 0.07
Nodes (53): applyBulkEdit(), applyDashLayout(), applyReportLayout(), applyTemplate(), autoPopulateReport(), buildBoardPackContent(), captureAreaAsCanvas(), captureFullFeatureGantt() (+45 more)

### Community 9 - "Risks & Raid & Md"
Cohesion: 0.06
Nodes (47): applyBulkEdit(), autoPopulateReport(), cancelEditFeature(), captureAreaAsCanvas(), captureFullGanttChart(), closeAllFlyouts(), closeFeatFlyout(), closeRaidFlyout() (+39 more)

### Community 10 - "Readme & Md & Project"
Cohesion: 0.08
Nodes (41): autoFitCol(), doGridSort(), doSort(), filterTasksByAssignee(), finalizeColOrder(), getGridFiltered(), getGridPK(), getGridSorted() (+33 more)
...
Cohesion: 0.08
Nodes (40): applyBulkEdit(), autoFitCol(), doGridSort(), doSort(), downloadGanttAsHtml(), finalizeColOrder(), getFiltered(), getGridFiltered() (+32 more)

### Community 13 - "Team & Capacity & Role"
Cohesion: 0.09
Nodes (39): autoFitCol(), doGridSort(), doSort(), filterDashboardMetric(), finalizeColOrder(), getGridFiltered(), getGridPK(), getGridSorted() (+31 more)

### Community 14 - "Defects & Defect & Bug"
Cohesion: 0.08
Nodes (38): clearMatrixFilter(), closeRaidFlyout(), deleteFeature(), deleteRaidItem(), deleteRaidItemById(), filterRaid(), initFeatScreenSearch(), keys (+30 more)
...
Cohesion: 0.06
Nodes (38): addLog(), addNewGUIScreen(), applyWorkflowTemplate(), closeFlyout(), closeMemberFlyout(), commitSchedulerSchedule(), confirmDeleteTask(), deleteMember() (+30 more)
...
Cohesion: 0.13
Nodes (24): autoResolveAllSchedulerConflicts(), autoSequenceAssignee(), changeSchedulerWeek(), clearMatrixFilter(), filterRaid(), findScheduleConflicts(), generateIntelligentSuggestions(), getTeamNames() (+16 more)
...
Cohesion: 0.14
Nodes (20): clearProjectState(), computeAlerts(), dismissAlert(), dismissAllAlerts(), enterApp(), loadCustomLayouts(), loadSample(), moveViewOrder() (+12 more)
...
Cohesion: 0.12
Nodes (17): addScaffoldRow(), createBaselineSnapshot(), deleteBaselineSnapshot(), duplicateScaffoldRow(), generateFromScaffold(), loadScaffoldTemplate(), removeScaffoldRow(), renderAdminView() (+9 more)
...
- **Why does `$id()` connect `Manual & State & Md` to `Configuration & Reference & Status`, `Changelog & 2026 & 05`, `Community 39`, `Insights & Burn & Md`, `Defects & Defect & Bug`, `Community 48`, `Community 49`, `User Manual & Architecture & Sync`, `Capacity & Workload & Role`, `Defect Tracker & Bug Lifecycle`, `Status & Dashboard & Live`, `Community 29`, `Community 30`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `$id()` connect `Readme & Typescript & Entity` to `Community 32`, `Community 33`, `Architecture & Audit & State`, `Scheduler & The & Heuristic`, `Risks & Raid & Md`, `Readme & Md & Project`, `Community 42`, `Project & Status & Md`, `Delivery Matrix & Hierarchy & Edit`, `Widgets & Capture & Screenshot`, `Community 26`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `$id()` connect `Schedule & Manual & Check` to `Readme & State & Block`, `Community 38`, `Overview & Md & Executive`, `Community 41`, `Delivery & Md & Hierarchical`, `Team & Capacity & Role`, `Reports & Board & Md`, `Activity & Md & Audit`, `Reports & Board & Export`, `Audit Log & Activity & Session`, `Community 27`?**
