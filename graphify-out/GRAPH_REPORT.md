...
- `updateBulkBar()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 3 → community 41_
...
Cohesion: 0.06
Nodes (65): addDDValueV(), addRelease(), applyDashLayout(), applyReportLayout(), applyTemplate(), autoPopulateReport(), buildBoardPackContent(), closeModal() (+57 more)
...
Cohesion: 0.06
Nodes (39): addLog(), clearProjectState(), closeFlyout(), closeMemberFlyout(), commitSchedulerSchedule(), confirmDeleteTask(), deleteMember(), deleteTask() (+31 more)
...
Cohesion: 0.09
Nodes (23): addScaffoldRow(), closeTplFlyout(), createBaselineSnapshot(), deleteBaselineSnapshot(), duplicateScaffoldRow(), finalizeTplUpdateV(), generateFromScaffold(), loadScaffoldTemplate() (+15 more)
...
- **Why does `$id()` connect `Manual & State & Md` to `Readme & State & Block`, `Architecture & Audit & State`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Community 41`, `Readme & Md & Project`, `Risks & Raid & Md`, `Insights & Burn & Md`, `Community 48`, `Project & Status & Md`, `Activity & Md & Audit`, `Defect Tracker & Bug Lifecycle`, `Status & Dashboard & Live`, `Community 30`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `$id()` connect `Changelog & 2026 & 05` to `Configuration & Reference & Status`, `Readme & Typescript & Entity`, `Delivery & Md & Hierarchical`, `Team & Capacity & Role`, `Defects & Defect & Bug`, `Reports & Board & Md`, `Delivery Matrix & Hierarchy & Edit`, `Reports & Board & Export`, `Audit Log & Activity & Session`, `Widgets & Capture & Screenshot`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 31`, `Community 34`, `Community 35`, `Community 39`, `Community 44`, `Community 45`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `save()` connect `Architecture & Audit & State` to `Readme & State & Block`, `Manual & State & Md`, `Community 38`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Insights & Burn & Md`, `Activity & Md & Audit`, `Defect Tracker & Bug Lifecycle`, `Status & Dashboard & Live`, `Community 30`?**
