...
- `renderViewToggle()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 3 → community 26_
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 3 → community 12_
...
- `updateBulkBar()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 3 → community 45_
...
Cohesion: 0.05
Nodes (72): addLog(), addNewGUIScreen(), addRelease(), applyDashLayout(), applyReportLayout(), applyTemplate(), applyWorkflowTemplate(), buildBoardPackContent() (+64 more)
...
Cohesion: 0.07
Nodes (38): addCustomFieldV(), addDDValueV(), autoPopulateReport(), cancelEditFeature(), captureAreaAsCanvas(), captureFullGanttChart(), closeAllFlyouts(), closeFeatFlyout() (+30 more)
...
- **Why does `$id()` connect `Manual & State & Md` to `Readme & State & Block`, `Architecture & Audit & State`, `Readme & Typescript & Entity`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Risks & Raid & Md`, `Insights & Burn & Md`, `Community 45`, `Community 46`, `Reports & Board & Md`, `Delivery Matrix & Hierarchy & Edit`, `Community 53`, `Community 54`, `Status & Dashboard & Live`, `Community 26`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `$id()` connect `Defects & Defect & Bug` to `Configuration & Reference & Status`, `Schedule & Manual & Check`, `Readme & Md & Project`, `Delivery & Md & Hierarchical`, `Team & Capacity & Role`, `Activity & Md & Audit`, `User Manual & Architecture & Sync`, `Capacity & Workload & Role`, `Defect Tracker & Bug Lifecycle`, `Audit Log & Activity & Session`, `Widgets & Capture & Screenshot`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 38`, `Community 39`, `Community 42`, `Community 43`, `Community 44`, `Community 48`, `Community 49`, `Community 50`, `Community 51`, `Community 57`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `notify()` connect `Scheduler & The & Heuristic` to `Readme & State & Block`, `Architecture & Audit & State`, `Manual & State & Md`, `Overview & Md & Executive`, `Risks & Raid & Md`, `Insights & Burn & Md`, `Reports & Board & Md`, `Delivery Matrix & Hierarchy & Edit`, `Status & Dashboard & Live`, `Community 26`?**
