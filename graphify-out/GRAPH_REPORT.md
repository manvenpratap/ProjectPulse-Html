...
- `syncFsDirectory()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 2 → community 19_
...
Cohesion: 0.05
Nodes (57): addLog(), applyDashLayout(), applyTemplate(), autoPopulateReport(), captureAreaAsCanvas(), captureFullGanttChart(), closeDefectFlyout(), closeMemberFlyout() (+49 more)
...
Cohesion: 0.07
Nodes (47): addDDValueV(), addRelease(), applyReportLayout(), buildBoardPackContent(), createNewGlobalSet(), cycleCwSize(), cycleStandardSize(), deleteGlobalSet() (+39 more)
...
Cohesion: 0.11
Nodes (21): addNewGUIScreen(), applyTemplate(), applyWorkflowTemplate(), commitSchedulerSchedule(), deleteMember(), drawAreaChart(), drawVBar(), fmtDate() (+13 more)

### Community 17 - "Project & Status & Md"
Cohesion: 0.17
Nodes (20): applyDashLayout(), applyReportLayout(), buildBoardPackContent(), closeModal(), cycleCwSize(), cycleStandardSize(), getBoardPackHtml(), renderDash() (+12 more)
...
Cohesion: 0.11
Nodes (19): createBaselineSnapshot(), createFileBackup(), deleteBaselineSnapshot(), editReport(), generateProjectWorkbook(), getExcelFileBlob(), listBackups(), openNewReport() (+11 more)
...
Cohesion: 0.16
Nodes (15): addLog(), autoPopulateReport(), closeMemberFlyout(), closeTplFlyout(), finalizeTplUpdateV(), notify(), openAddMember(), propagateTemplateUpdate() (+7 more)
...
- **Why does `$id()` connect `Architecture & Audit & State` to `Readme & State & Block`, `Manual & State & Md`, `Schedule & Manual & Check`, `Scheduler & The & Heuristic`, `Readme & Md & Project`, `Community 45`, `Defects & Defect & Bug`, `Team & Capacity & Role`, `Community 46`, `Delivery Matrix & Hierarchy & Edit`, `Capacity & Workload & Role`, `Reports & Board & Export`, `Community 55`, `Widgets & Capture & Screenshot`, `Community 54`, `Community 27`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `$id()` connect `Delivery & Md & Hierarchical` to `Configuration & Reference & Status`, `Readme & Typescript & Entity`, `Overview & Md & Executive`, `Risks & Raid & Md`, `Insights & Burn & Md`, `Activity & Md & Audit`, `Project & Status & Md`, `Defect Tracker & Bug Lifecycle`, `Audit Log & Activity & Session`, `Status & Dashboard & Live`, `Community 26`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 36`, `Community 37`, `Community 39`, `Community 40`, `Community 43`, `Community 44`, `Community 48`, `Community 49`, `Community 50`, `Community 52`, `Community 57`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `notify()` connect `Manual & State & Md` to `Readme & State & Block`, `Architecture & Audit & State`, `Schedule & Manual & Check`, `Readme & Md & Project`, `Team & Capacity & Role`, `Defects & Defect & Bug`, `Delivery Matrix & Hierarchy & Edit`, `Capacity & Workload & Role`, `Widgets & Capture & Screenshot`, `Community 27`?**
