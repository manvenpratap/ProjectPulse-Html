# Graph Report - ProjectPulse  (2026-07-26)

## Corpus Check
- 4 files · ~538,505 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1270 nodes · 2869 edges · 63 communities (55 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4059838b`
...
- `renderViewToggle()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 12 → community 24_
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 12 → community 17_
- `syncFsDirectory()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 12 → community 8_
- `updateBulkBar()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 12 → community 49_
- `applyBulkEdit()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 12 → community 10_
...
Cohesion: 0.06
Nodes (62): addDDValueV(), addRelease(), applyDashLayout(), applyReportLayout(), applyTemplate(), autoPopulateReport(), buildBoardPackContent(), closeModal() (+54 more)
...
Cohesion: 0.06
Nodes (39): addLog(), addNewGUIScreen(), applyWorkflowTemplate(), closeFlyout(), closeMemberFlyout(), commitSchedulerSchedule(), confirmDeleteTask(), deleteMember() (+31 more)
...
Cohesion: 0.08
Nodes (28): createBaselineSnapshot(), createFileBackup(), deleteBaselineSnapshot(), editReport(), generateProjectWorkbook(), getExcelFileBlob(), listBackups(), loadCustomLayouts() (+20 more)
...
Cohesion: 0.1
Nodes (22): addScaffoldRow(), closeTplFlyout(), duplicateScaffoldRow(), finalizeTplUpdateV(), generateFromScaffold(), loadScaffoldTemplate(), propagateTemplateUpdate(), removeScaffoldRow() (+14 more)
...
Cohesion: 0.14
Nodes (20): cancelEditCw(), editCustomWidgetCtx(), editCw(), _matrixCellClick(), moveDashSec(), moveRptSec(), openDashBuilder(), openDateLegendModal() (+12 more)
...
Cohesion: 0.18
Nodes (12): addCustomFieldV(), closeAllFlyouts(), filterDefectLinkOptions(), getAllScreens(), importScaffoldBulk(), openDefectModal(), raiseDefectForEntity(), renderCFListV() (+4 more)
...
Cohesion: 0.25
Nodes (9): downloadGanttAsHtml(), exportFeatureMatrixExcel(), exportLogCSV(), exportProjectExcel(), renderTaskSwimlane(), runMonteCarloSimulation(), setGanttZoom(), shareView() (+1 more)
...
Cohesion: 0.5
Nodes (4): applyPvFilt(), cap(), getFieldType(), pickPvFilt()
...
- **Why does `$id()` connect `Insights & Burn & Md` to `Readme & State & Block`, `Manual & State & Md`, `Readme & Typescript & Entity`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Readme & Md & Project`, `Defects & Defect & Bug`, `Project & Status & Md`, `Widgets & Capture & Screenshot`, `Status & Dashboard & Live`, `Community 27`, `Community 28`, `Community 31`, `Community 33`, `Community 37`, `Community 40`, `Community 41`, `Community 42`, `Community 47`, `Community 48`, `Community 49`, `Community 51`, `Community 55`, `Community 58`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `$id()` connect `Architecture & Audit & State` to `Configuration & Reference & Status`, `Schedule & Manual & Check`, `Risks & Raid & Md`, `Delivery & Md & Hierarchical`, `Reports & Board & Md`, `Activity & Md & Audit`, `Delivery Matrix & Hierarchy & Edit`, `Capacity & Workload & Role`, `Defect Tracker & Bug Lifecycle`, `Reports & Board & Export`, `Audit Log & Activity & Session`, `Community 26`, `Community 29`, `Community 30`, `Community 32`, `Community 35`, `Community 36`, `Community 39`, `Community 46`, `Community 52`, `Community 53`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `notify()` connect `Manual & State & Md` to `Readme & State & Block`, `Community 33`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Community 41`, `Readme & Md & Project`, `Community 42`, `Defects & Defect & Bug`, `Project & Status & Md`, `Widgets & Capture & Screenshot`, `Status & Dashboard & Live`, `Community 27`, `Community 28`, `Community 31`?**
