...
## Corpus Check
- 4 files · ~308,346 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1270 nodes · 2869 edges · 67 communities (58 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `11eb073d`
...
- `renderViewToggle()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 2 → community 22_
...
- `updateBulkBar()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 2 → community 50_
...
- `submitComment()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 2 → community 38_
...
Cohesion: 0.05
Nodes (67): addCustomFieldV(), addDep(), addLeaveRow(), cancelEditFeature(), cancelTplConfirmV(), clearPvFilt(), closeAllFlyouts(), closeCmdPalette() (+59 more)
...
Cohesion: 0.1
Nodes (31): buildBoardPackContent(), cancelEditCw(), cycleCwSize(), cycleStandardSize(), editCustomWidgetCtx(), editCw(), getBoardPackHtml(), getModuleMilestones() (+23 more)

### Community 7 - "Scheduler & The & Heuristic"
Cohesion: 0.08
Nodes (28): createBaselineSnapshot(), createFileBackup(), deleteBaselineSnapshot(), editReport(), exportFeatureMatrixExcel(), exportLogCSV(), exportProjectExcel(), generateProjectWorkbook() (+20 more)
...
Cohesion: 0.1
Nodes (26): addEmptyState(), applyPvFilt(), cap(), closeCtx(), esc(), getFieldType(), _matrixCellHover(), _matrixStateChange() (+18 more)
...
Cohesion: 0.1
Nodes (26): closeCtx(), downloadGanttAsHtml(), esc(), formatDateStringFriendly(), _matrixCellHover(), _matrixStateChange(), openAddTask(), openFlyout() (+18 more)
...
Cohesion: 0.09
Nodes (25): createBaselineSnapshot(), createFileBackup(), deleteBaselineSnapshot(), editReport(), generateProjectWorkbook(), getExcelFileBlob(), listBackups(), _matrixCellClick() (+17 more)
...
Cohesion: 0.12
Nodes (20): addNewGUIScreen(), applyWorkflowTemplate(), commitSchedulerSchedule(), deleteMember(), drawAreaChart(), drawVBar(), fmtDate(), getModuleMilestones() (+12 more)
...
Cohesion: 0.14
Nodes (19): addDDValueV(), clearProjectState(), createNewGlobalSet(), deleteGlobalSet(), enterApp(), loadSample(), recalcGUIScreenByRefs(), removeDDValueV() (+11 more)
...
Cohesion: 0.18
Nodes (16): applyDashLayout(), applyReportLayout(), applyTemplate(), autoPopulateReport(), closeModal(), closeTplFlyout(), finalizeTplUpdateV(), notify() (+8 more)
...
Cohesion: 0.5
Nodes (5): addLog(), submitComment(), triggerConfetti(), updateGUIStep(), updateSubtask()
...
- **Why does `$id()` connect `Architecture & Audit & State` to `Readme & State & Block`, `Schedule & Manual & Check`, `Readme & Typescript & Entity`, `Overview & Md & Executive`, `Risks & Raid & Md`, `Team & Capacity & Role`, `Capacity & Workload & Role`, `Reports & Board & Export`, `Audit Log & Activity & Session`, `Widgets & Capture & Screenshot`, `Status & Dashboard & Live`, `Community 26`, `Community 28`, `Community 30`, `Community 34`, `Community 38`, `Community 48`, `Community 50`, `Community 58`, `Community 61`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `$id()` connect `Readme & Md & Project` to `Configuration & Reference & Status`, `Changelog & 2026 & 05`, `Scheduler & The & Heuristic`, `Delivery & Md & Hierarchical`, `Insights & Burn & Md`, `Defects & Defect & Bug`, `Activity & Md & Audit`, `Project & Status & Md`, `User Manual & Architecture & Sync`, `Defect Tracker & Bug Lifecycle`, `Community 27`, `Community 29`, `Community 31`, `Community 32`, `Community 33`, `Community 37`, `Community 39`, `Community 40`, `Community 43`, `Community 44`, `Community 47`, `Community 49`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 57`, `Community 66`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `notify()` connect `Community 26` to `Readme & State & Block`, `Architecture & Audit & State`, `Community 34`, `Community 38`, `Readme & Typescript & Entity`, `Overview & Md & Executive`, `Risks & Raid & Md`, `Team & Capacity & Role`, `Community 48`, `Reports & Board & Export`, `Audit Log & Activity & Session`, `Status & Dashboard & Live`, `Community 28`, `Community 30`?**
