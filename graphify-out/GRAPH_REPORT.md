# Graph Report - ProjectPulse  (2026-07-28)

## Corpus Check
- 4 files · ~283,500 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1270 nodes · 2869 edges · 67 communities (59 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `078a664f`
...
- `renderViewToggle()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 9 → community 26_
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 9 → community 7_
- `syncFsDirectory()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 9 → community 43_
- `updateBulkBar()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 9 → community 54_
- `applyBulkEdit()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 9 → community 8_
...
Cohesion: 0.05
Nodes (64): addCustomFieldV(), addDep(), addLeaveRow(), cancelTplConfirmV(), clearPvFilt(), closeAllFlyouts(), closeCmdPalette(), closeDefectFlyout() (+56 more)
...
Cohesion: 0.08
Nodes (33): addGrid(), addST(), closeCtx(), esc(), formatDateStringFriendly(), _matrixCellHover(), _matrixStateChange(), mkCC() (+25 more)
...
Cohesion: 0.12
Nodes (22): addEmptyState(), closeCtx(), esc(), _matrixCellHover(), _matrixStateChange(), openAddTask(), openFlyout(), openReleaseAssetsFlyout() (+14 more)

### Community 13 - "Team & Capacity & Role"
Cohesion: 0.1
Nodes (21): addScaffoldRow(), createBaselineSnapshot(), deleteBaselineSnapshot(), duplicateScaffoldRow(), generateFromScaffold(), loadScaffoldTemplate(), removeScaffoldRow(), renderAdminView() (+13 more)
...
Cohesion: 0.15
Nodes (20): applyDashLayout(), applyReportLayout(), buildBoardPackContent(), cycleCwSize(), cycleStandardSize(), getBoardPackHtml(), getModuleMilestones(), renderDash() (+12 more)

### Community 16 - "Activity & Md & Audit"
Cohesion: 0.16
Nodes (20): applyDashLayout(), applyTemplate(), autoPopulateReport(), captureAreaAsCanvas(), captureFullFeatureGantt(), captureFullGanttChart(), closeModal(), closeTplFlyout() (+12 more)
...
Cohesion: 0.11
Nodes (18): closeDefectFlyout(), closeFlyout(), closeMemberFlyout(), commitSchedulerSchedule(), confirmDeleteTask(), deleteMember(), deleteTask(), drawAreaChart() (+10 more)
...
Cohesion: 0.12
Nodes (18): addLog(), closeMemberFlyout(), commitSchedulerSchedule(), deleteMember(), drawAreaChart(), drawVBar(), getModuleMilestones(), render() (+10 more)
...
Cohesion: 0.12
Nodes (17): createBaselineSnapshot(), deleteBaselineSnapshot(), editReport(), _matrixCellClick(), openDashBuilder(), openDateLegendModal(), openModal(), openNewReport() (+9 more)
...
Cohesion: 0.22
Nodes (14): closeRaidFlyout(), computeAlerts(), deleteRaidItem(), deleteRaidItemById(), dismissAlert(), dismissAllAlerts(), nowISO(), pruneAlertHistory() (+6 more)
...
Cohesion: 0.21
Nodes (13): applyTemplate(), autoPopulateReport(), closeModal(), closeTplFlyout(), finalizeTplUpdateV(), notify(), openAddMember(), propagateTemplateUpdate() (+5 more)

### Community 31 - "Community 31"
Cohesion: 0.18
Nodes (13): addNewGUIScreen(), applyWorkflowTemplate(), fmtDate(), markAllGUIStepsDone(), openScreenFlyout(), renderGUIScreens(), renderWhatIfSandbox(), resetWhatIfSandbox() (+5 more)
...
Cohesion: 0.18
Nodes (11): commitWhatIfScenario(), filterTasksByAssignee(), filterTasksByRole(), filterToWeek(), openEwsModal(), renderOverviewView(), renderSkeleton(), runEarlyWarningScanners() (+3 more)

### Community 35 - "Community 35"
Cohesion: 0.2
Nodes (10): cancelEditFeature(), closeFeatFlyout(), deleteFeature(), initFeatGanttResizer(), initFeatScreenSearch(), renderFeatureGantt(), renderFeatureHub(), renderFeatureSwimlane() (+2 more)
...
- **Why does `$id()` connect `Risks & Raid & Md` to `Readme & State & Block`, `Schedule & Manual & Check`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Insights & Burn & Md`, `Team & Capacity & Role`, `Reports & Board & Md`, `User Manual & Architecture & Sync`, `Delivery Matrix & Hierarchy & Edit`, `Status & Dashboard & Live`, `Community 26`, `Community 27`, `Community 30`, `Community 31`, `Community 34`, `Community 35`, `Community 41`, `Community 42`, `Community 43`, `Community 44`, `Community 45`, `Community 46`, `Community 51`, `Community 52`, `Community 53`, `Community 54`, `Community 59`, `Community 62`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `$id()` connect `Architecture & Audit & State` to `Configuration & Reference & Status`, `Changelog & 2026 & 05`, `Readme & Typescript & Entity`, `Readme & Md & Project`, `Defects & Defect & Bug`, `Activity & Md & Audit`, `Capacity & Workload & Role`, `Defect Tracker & Bug Lifecycle`, `Reports & Board & Export`, `Audit Log & Activity & Session`, `Widgets & Capture & Screenshot`, `Community 28`, `Community 29`, `Community 32`, `Community 33`, `Community 36`, `Community 40`, `Community 50`, `Community 56`, `Community 58`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `notify()` connect `Community 30` to `Readme & State & Block`, `Community 34`, `Community 35`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Community 41`, `Community 42`, `Community 43`, `Insights & Burn & Md`, `Community 45`, `Community 46`, `Reports & Board & Md`, `Team & Capacity & Role`, `User Manual & Architecture & Sync`, `Delivery Matrix & Hierarchy & Edit`, `Status & Dashboard & Live`, `Community 26`, `Community 27`?**
