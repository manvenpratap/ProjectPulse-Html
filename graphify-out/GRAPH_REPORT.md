...
## Corpus Check
- 4 files · ~270,985 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1270 nodes · 2869 edges · 65 communities (55 shown, 10 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5b90fe70`
...
- `renderViewToggle()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 3 → community 24_
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 3 → community 11_
- `syncFsDirectory()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 3 → community 18_
- `updateBulkBar()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 3 → community 48_
- `applyBulkEdit()` --calls--> `$id()`  [EXTRACTED]
  temp_script3.js → temp_script3.js  _Bridges community 3 → community 7_
...
Cohesion: 0.05
Nodes (81): addDDValueV(), addLog(), addRelease(), applyDashLayout(), applyReportLayout(), applyTemplate(), autoPopulateReport(), buildBoardPackContent() (+73 more)
...
Cohesion: 0.14
Nodes (23): applyDashLayout(), applyReportLayout(), applyTemplate(), buildBoardPackContent(), closeModal(), cycleCwSize(), cycleStandardSize(), getBoardPackHtml() (+15 more)
...
Cohesion: 0.18
Nodes (16): autoPopulateReport(), captureAreaAsCanvas(), captureFullFeatureGantt(), captureFullGanttChart(), closeTplFlyout(), copyAllShares(), copyChart(), copyWidgetAsImage() (+8 more)
...
- **Why does `$id()` connect `Manual & State & Md` to `Readme & State & Block`, `Architecture & Audit & State`, `Community 26`, `Readme & Typescript & Entity`, `Scheduler & The & Heuristic`, `Delivery & Md & Hierarchical`, `Reports & Board & Md`, `Community 48`, `Community 47`, `User Manual & Architecture & Sync`, `Project & Status & Md`, `Defect Tracker & Bug Lifecycle`, `Community 55`, `Widgets & Capture & Screenshot`, `Community 56`, `Community 29`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `$id()` connect `Overview & Md & Executive` to `Configuration & Reference & Status`, `Schedule & Manual & Check`, `Risks & Raid & Md`, `Readme & Md & Project`, `Insights & Burn & Md`, `Team & Capacity & Role`, `Activity & Md & Audit`, `Delivery Matrix & Hierarchy & Edit`, `Reports & Board & Export`, `Audit Log & Activity & Session`, `Status & Dashboard & Live`, `Community 27`, `Community 28`, `Community 30`, `Community 31`, `Community 32`, `Community 36`, `Community 37`, `Community 38`, `Community 39`, `Community 41`, `Community 42`, `Community 45`, `Community 46`, `Community 50`, `Community 52`, `Community 53`, `Community 54`, `Community 64`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `notify()` connect `Architecture & Audit & State` to `Readme & State & Block`, `Manual & State & Md`, `Scheduler & The & Heuristic`, `Delivery & Md & Hierarchical`, `Reports & Board & Md`, `Project & Status & Md`, `User Manual & Architecture & Sync`, `Defect Tracker & Bug Lifecycle`, `Widgets & Capture & Screenshot`, `Community 29`?**
