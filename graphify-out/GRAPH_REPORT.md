# Graph Report - ProjectPulse  (2026-09-07)

## Corpus Check
- 4 files · ~396,523 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2394 nodes · 4951 edges · 65 communities (56 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0f8a976c`
...
- `copyCxoEmailToClipboard()` --calls--> `warn()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 25 → community 22_
- `syncFsDirectory()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 41 → community 25_
- `restoreFromFileBackup()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 41 → community 15_
- `updateCxoEmailPreview()` --calls--> `error()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 41 → community 22_
- `showViewHelp()` --calls--> `$id()`  [EXTRACTED]
  temp_test.js → temp_test.js  _Bridges community 6 → community 23_
...
Cohesion: 0.01
Nodes (93): activeModal, allDone, anyStarted, autoFitAllCols(), blocked, bulkDeleteTasks(), bulkSelectedTasks, c (+85 more)

### Community 2 - "Architecture & Audit & State"
Cohesion: 0.01
Nodes (87): activeModal, addGrid(), addST(), allDone, anyStarted, blocked, bulkDeleteTasks(), bulkSelectedTasks (+79 more)

### Community 3 - "Manual & State & Md"
Cohesion: 0.04
Nodes (88): addCustomFieldV(), addDep(), addLeaveRow(), cancelTplConfirmV(), clearPvFilt(), closeCmdPalette(), closeCtx(), closeDefectLinkDropdown() (+80 more)

### Community 4 - "Changelog & 2026 & 05"
Cohesion: 0.04
Nodes (88): addCustomFieldV(), addDep(), addLeaveRow(), addScaffoldRow(), cancelTplConfirmV(), clearPvFilt(), closeCmdPalette(), closeCtx() (+80 more)

### Community 5 - "Schedule & Manual & Check"
Cohesion: 0.04
Nodes (69): addDDValueV(), addLog(), applyDashLayout(), applyTemplate(), autoPopulateReport(), captureAreaAsCanvas(), captureFullGanttChart(), closeDefectFlyout() (+61 more)
...
Cohesion: 0.07
Nodes (49): addLog(), applyDashLayout(), applyReportLayout(), applyTemplate(), autoPopulateReport(), captureAreaAsCanvas(), captureFullFeatureGantt(), captureFullGanttChart() (+41 more)

### Community 8 - "Overview & Md & Executive"
Cohesion: 0.07
Nodes (47): addRelease(), applyBulkEdit(), autoFitAllCols(), autoFitCol(), closeDD(), _closeDDH(), deleteRelease(), doGridSort() (+39 more)

### Community 9 - "Risks & Raid & Md"
Cohesion: 0.07
Nodes (42): cancelEditFeature(), clearMatrixFilter(), closeAllFlyouts(), closeFeatFlyout(), closeRaidFlyout(), deleteFeature(), deleteRaidItem(), deleteRaidItemById() (+34 more)

### Community 10 - "Readme & Md & Project"
Cohesion: 0.07
Nodes (42): autoResolveAllSchedulerConflicts(), autoSequenceAssignee(), cancelEditFeature(), changeSchedulerWeek(), clearMatrixFilter(), closeAllFlyouts(), closeFeatFlyout(), closeRaidFlyout() (+34 more)

### Community 11 - "Delivery & Md & Hierarchical"
Cohesion: 0.06
Nodes (41): applyPvFilt(), buildBoardPackContent(), cancelEditCw(), cap(), cycleCwSize(), cycleStandardSize(), editCustomWidgetCtx(), editCw() (+33 more)

### Community 12 - "Insights & Burn & Md"
Cohesion: 0.08
Nodes (40): autoFitCol(), doGridSort(), doSort(), finalizeColOrder(), getGridFiltered(), getGridPK(), getGridSorted(), getSorted() (+32 more)

### Community 13 - "Team & Capacity & Role"
Cohesion: 0.07
Nodes (37): addDDValueV(), addRelease(), applyBulkEdit(), clearProjectState(), createNewGlobalSet(), deleteGlobalSet(), deleteRelease(), drawAgeBars() (+29 more)

### Community 14 - "Defects & Defect & Bug"
Cohesion: 0.08
Nodes (36): addEmptyState(), autoResolveAllSchedulerConflicts(), autoSequenceAssignee(), changeSchedulerWeek(), clearMatrixFilter(), filterRaid(), findScheduleConflicts(), formatDateStringFriendly() (+28 more)

### Community 15 - "Reports & Board & Md"
Cohesion: 0.09
Nodes (35): addLog(), applyDashLayout(), applyTemplate(), autoPopulateReport(), closeDefectFlyout(), closeMemberFlyout(), closeModal(), closeTplFlyout() (+27 more)

### Community 16 - "Activity & Md & Audit"
Cohesion: 0.11
Nodes (34): addRelease(), applyBulkEdit(), autoFitCol(), deleteRelease(), doGridSort(), doSort(), filterDefectsBy(), finalizeColOrder() (+26 more)
...
Cohesion: 0.08
Nodes (29): addNewGUIScreen(), aggregateCustomData(), applyWorkflowTemplate(), commitWhatIfScenario(), entries, esc(), fmtDate(), getFilteredLogs() (+21 more)
...
Cohesion: 0.1
Nodes (28): addEmptyState(), deleteReport(), esc(), formatDateStringFriendly(), generateFullBoardPackHtml(), getBoardPackHtml(), getModuleMilestones(), _matrixCellHover() (+20 more)

### Community 21 - "Defect Tracker & Bug Lifecycle"
Cohesion: 0.08
Nodes (27): addScaffoldRow(), cancelEditFeature(), closeAllFlyouts(), closeFeatFlyout(), createBaselineSnapshot(), deleteBaselineSnapshot(), duplicateScaffoldRow(), generateFromScaffold() (+19 more)
...
Cohesion: 0.1
Nodes (22): clearProjectState(), createFileBackup(), enterApp(), listBackups(), loadCustomLayouts(), loadSample(), moveViewOrder(), openSettings() (+14 more)
...
Cohesion: 0.18
Nodes (19): animateCounter(), applyReportLayout(), buildBoardPackContent(), cycleCwSize(), cycleStandardSize(), deleteReport(), generateFullBoardPackHtml(), getBoardPackHtml() (+11 more)

### Community 28 - "Community 28"
Cohesion: 0.13
Nodes (18): getSorted(), renderGantt(), renderKanban(), renderModuleRollups(), renderTasksView(), renderTaskSwimlane(), renderTimeline(), selectMS() (+10 more)
...
Cohesion: 0.15
Nodes (17): downloadGanttAsHtml(), getFiltered(), getModuleMilestones(), getSorted(), getTasksForDisplayLevel(), initFeatGanttResizer(), rect, renderFeatureGantt() (+9 more)
...
Cohesion: 0.13
Nodes (15): applyPvFilt(), cap(), editReport(), getFieldType(), _matrixCellClick(), openDateLegendModal(), openModal(), openNewReport() (+7 more)
...
Cohesion: 0.18
Nodes (13): createFileBackup(), generateProjectWorkbook(), getExcelFileBlob(), listBackups(), loadCustomLayouts(), printContainer(), renderAdminContent(), renderBackupList() (+5 more)
...
Cohesion: 0.18
Nodes (12): createBaselineSnapshot(), deleteBaselineSnapshot(), editReport(), formatRaidDateSince(), getRaidAgeDays(), getRaidDateSince(), openNewReport(), openRaidModal() (+4 more)
...
Cohesion: 0.36
Nodes (10): computeAlerts(), dismissAlert(), dismissAllAlerts(), nowISO(), pruneAlertHistory(), reactivateAlert(), renderAlertsPanel(), saveRaidItem() (+2 more)
...
- **Why does `$id()` connect `Readme & Typescript & Entity` to `Configuration & Reference & Status`, `Community 34`, `Community 37`, `Risks & Raid & Md`, `Community 42`, `Community 43`, `Community 45`, `Reports & Board & Md`, `Activity & Md & Audit`, `User Manual & Architecture & Sync`, `Delivery Matrix & Hierarchy & Edit`, `Audit Log & Activity & Session`, `Community 53`, `Reports & Board & Export`, `Community 55`, `Status & Dashboard & Live`, `Community 27`, `Community 30`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `$id()` connect `Manual & State & Md` to `Community 32`, `Community 33`, `Architecture & Audit & State`, `Schedule & Manual & Check`, `Community 38`, `Overview & Md & Executive`, `Defects & Defect & Bug`, `Project & Status & Md`, `Defect Tracker & Bug Lifecycle`, `Community 28`, `Community 31`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `$id()` connect `Changelog & 2026 & 05` to `Readme & State & Block`, `Scheduler & The & Heuristic`, `Community 39`, `Readme & Md & Project`, `Delivery & Md & Hierarchical`, `Insights & Burn & Md`, `Team & Capacity & Role`, `Community 44`, `Community 47`, `Capacity & Workload & Role`, `Community 29`?**
