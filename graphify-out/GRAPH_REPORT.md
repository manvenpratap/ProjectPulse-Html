# Graph Report - ProjectPulse  (2026-08-07)

## Corpus Check
- 4 files · ~310,299 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1270 nodes · 2869 edges · 61 communities (52 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8ae9ee2b`
...
Cohesion: 0.05
Nodes (70): addDep(), addLeaveRow(), cancelTplConfirmV(), clearPvFilt(), closeCmdPalette(), closeCtx(), closeDefectFlyout(), closeDefectLinkDropdown() (+62 more)

### Community 3 - "Manual & State & Md"
Cohesion: 0.05
Nodes (56): addCustomFieldV(), addDDValueV(), addScaffoldRow(), autoPopulateReport(), cancelEditFeature(), captureAreaAsCanvas(), captureFullGanttChart(), closeAllFlyouts() (+48 more)
...
Cohesion: 0.09
Nodes (33): addRelease(), closeRaidFlyout(), computeAlerts(), deleteRaidItem(), deleteRaidItemById(), deleteRelease(), dismissAlert(), dismissAllAlerts() (+25 more)
...
Cohesion: 0.13
Nodes (24): applyDashLayout(), applyReportLayout(), applyTemplate(), buildBoardPackContent(), closeModal(), cycleCwSize(), cycleStandardSize(), getBoardPackHtml() (+16 more)
...
Cohesion: 0.11
Nodes (23): addLog(), addNewGUIScreen(), applyWorkflowTemplate(), commitSchedulerSchedule(), deleteMember(), drawAreaChart(), drawVBar(), fmtDate() (+15 more)
...
Cohesion: 0.12
Nodes (18): addEmptyState(), esc(), _matrixCellHover(), _matrixStateChange(), openAddTask(), openEwsModal(), openFlyout(), openReleaseAssetsFlyout() (+10 more)

### Community 24 - "Widgets & Capture & Screenshot"
Cohesion: 0.19
Nodes (17): applyReportLayout(), buildBoardPackContent(), cycleCwSize(), cycleStandardSize(), getBoardPackHtml(), getModuleMilestones(), renderDash(), renderReports() (+9 more)
...
- **Why does `$id()` connect `Architecture & Audit & State` to `Readme & State & Block`, `Manual & State & Md`, `Readme & Typescript & Entity`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Risks & Raid & Md`, `Community 42`, `Delivery & Md & Hierarchical`, `Community 45`, `Reports & Board & Md`, `Audit Log & Activity & Session`, `Community 52`, `Community 54`, `Reports & Board & Export`, `Status & Dashboard & Live`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `$id()` connect `Insights & Burn & Md` to `Configuration & Reference & Status`, `Schedule & Manual & Check`, `Readme & Md & Project`, `Team & Capacity & Role`, `Defects & Defect & Bug`, `Activity & Md & Audit`, `Project & Status & Md`, `Delivery Matrix & Hierarchy & Edit`, `Capacity & Workload & Role`, `Widgets & Capture & Screenshot`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 33`, `Community 34`, `Community 35`, `Community 37`, `Community 38`, `Community 41`, `Community 43`, `Community 47`, `Community 48`, `Community 49`, `Community 50`, `Community 51`, `Community 60`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `notify()` connect `Manual & State & Md` to `Readme & State & Block`, `Architecture & Audit & State`, `Scheduler & The & Heuristic`, `Overview & Md & Executive`, `Risks & Raid & Md`, `Delivery & Md & Hierarchical`, `Reports & Board & Md`, `Reports & Board & Export`, `Audit Log & Activity & Session`, `Status & Dashboard & Live`?**
